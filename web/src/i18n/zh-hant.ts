...
export const zhHant: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "探索、安裝、啟用並更新 kova 外掛（對齊 `kova plugins` CLI）。",
    ...
    removeConfirm: "從 ~/.kova/plugins/ 移除此外掛？",
    removeHint: "僅可移除位於 ~/.kova/plugins 下使用者安裝的外掛。",
  ...
  skills: {
    ...
    categories: "分類",
    filters: "篩選",
    noSkills: "找不到技能。技能由 ~/.kova/skills/ 載入",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "從真實工作階段歷史中獲得的 kova 可收集徽章。已知尚未達成的成就會顯示為「已發現」；秘密成就在首次出現相符行為之前保持隱藏。",
      scan_subtitle:
        "正在掃描 kova 工作階段歷史。在歷史紀錄較多時，首次掃描可能需要 5–10 秒。",
    },
    actions: {
      rescan: "重新掃描",
    },
    ...
    guide: {
      ...
      secret_header: "秘密成就",
      secret_body:
        "秘密成就會隱藏其確切觸發條件。一旦 kova 偵測到相關訊號，卡片便會變為「已發現」並顯示其需求。",
      scan_status_header: "掃描狀態",
      scan_status_body:
        "kova 正在對本機歷史進行一次掃描，之後卡片會自動出現。即使需要幾秒鐘，也並未卡住。",
