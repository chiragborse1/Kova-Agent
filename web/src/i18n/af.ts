...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateKova: "Werk kova op",
    updatingKova: "Besig om kova op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk kova-inproppe op (`kova plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.kova/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.kova/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.kova/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare kova-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "kova-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik kova meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra kova 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "kova skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
