...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update kova plugins (`kova plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.kova/plugins/?",
    removeHint: "Only user-installed plugins under ~/.kova/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.kova/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible kova badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning kova session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run kova more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once kova sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "kova is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
