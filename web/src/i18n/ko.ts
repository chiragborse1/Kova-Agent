...
export const ko: Translations = {
  ...
  status: {
    ...
    stopped: "중지됨",
    updateKova: "kova 업데이트",
    updatingKova: "kova 업데이트 중…",
  ...
  pluginsPage: {
    ...
    headline:
      "kova 플러그인을 검색, 설치, 활성화 및 업데이트합니다 (`kova plugins` 동등).",
    ...
    removeConfirm: "~/.kova/plugins/에서 이 플러그인을 제거하시겠습니까?",
    removeHint: "~/.kova/plugins 아래에 사용자가 설치한 플러그인만 제거할 수 있습니다.",
  ...
  skills: {
    ...
    categories: "카테고리",
    filters: "필터",
    noSkills: "스킬을 찾을 수 없습니다. 스킬은 ~/.kova/skills/ 에서 로드됩니다",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "실제 세션 기록에서 획득하는 kova 컬렉터블 배지입니다. 알려져 있지만 아직 달성되지 않은 업적은 Discovered로 표시되며, Secret 업적은 일치하는 동작이 처음 나타날 때까지 숨겨집니다.",
      scan_subtitle:
        "kova 세션 기록을 스캔하고 있습니다. 기록이 많으면 첫 스캔에 5~10초가 걸릴 수 있습니다.",
    },
    actions: {
      rescan: "다시 스캔",
    },
    stats: {
      ...
      latest: "최근",
      latest_hint_empty: "Kova를 더 사용해 보세요",
      none_yet: "아직 없음",
    },
    state: {
      unlocked: "해제됨",
    ...
    guide: {
      ...
      secret_body:
        "시크릿은 정확한 트리거 조건을 숨깁니다. Kova가 관련 신호를 감지하면 카드가 Discovered로 바뀌고 요건이 표시됩니다.",
      scan_status_header: "스캔 상태",
      scan_status_body:
        "Kova는 로컬 기록을 한 번 스캔한 뒤 카드를 자동으로 표시합니다. 몇 초 걸리더라도 멈춘 것이 아닙니다.",
