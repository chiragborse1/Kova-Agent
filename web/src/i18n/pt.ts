...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateKova: "Atualizar kova",
    updatingKova: "A atualizar Kova…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins kova (paridade com `kova plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.kova/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.kova/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.kova/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do kova obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do kova. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o kova",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o kova detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O kova analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
