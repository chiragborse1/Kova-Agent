 ...
 *
 * Plugins call window.__KOVA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__KOVA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__KOVA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__KOVA_PLUGIN_SDK__ = {
    ...
    // window.__KOVA_SESSION_TOKEN__ directly.
    authedFetch,
