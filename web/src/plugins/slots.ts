 ...
 * `window.__KOVA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the kova brand in the top bar
 ...
 *  `window.__KOVA_PLUGINS__.registerSlot(...)`.
 *
