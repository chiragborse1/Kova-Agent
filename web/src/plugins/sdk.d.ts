/**
 * kova dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__KOVA_PLUGIN_SDK__`` and
 * ``window.__KOVA_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__KOVA_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``KovaPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@kova/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__KOVA_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__KOVA_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__KOVA_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface KovaPluginSDK {
...
declare global {
  interface Window {
    __KOVA_PLUGIN_SDK__?: KovaPluginSDK;
    __KOVA_PLUGINS__?: PluginRegistry;
  }
}
