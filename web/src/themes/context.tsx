...
const STORAGE_KEY = "kova-dashboard-theme";
...
const FONT_STORAGE_KEY = "kova-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `KOVA_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "kova-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-kova-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-kova-theme-font", "true");
