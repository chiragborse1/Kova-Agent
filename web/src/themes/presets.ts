 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `KOVA_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "kova Teal",
  description: "Classic dark teal — the canonical kova look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "kova Teal (Large)",
  description: "kova Teal with bigger fonts and roomier spacing",
