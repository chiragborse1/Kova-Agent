 ...
 *
 * Values mirror KOVA_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the kova default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (kova' default when unset). */
