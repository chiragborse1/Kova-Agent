# Streaming LLM Response Support for Kova Agent
...
```
KOVA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("KOVA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `KOVA_cli/config.py` | 1 | +streaming config defaults |
