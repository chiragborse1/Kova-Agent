...
- **Search both open *and* merged PRs and issues** for your topic or error symptom — the duplicate-check in the PR template fires at review time, after you've already done the work:
  ```bash
  gh search issues --repo chiragborse1/Kova-Agent "<your terms>"
  gh search prs --repo chiragborse1/Kova-Agent --state all "<your terms>"
  ```
  Or use the web UI: [issues](https://github.com/chiragborse1/Kova-Agent/issues?q=) · [PRs (all states)](https://github.com/chiragborse1/Kova-Agent/pulls?q=is%3Apr).
...
- Use [GitHub Issues](https://github.com/chiragborse1/Kova-Agent/issues)
