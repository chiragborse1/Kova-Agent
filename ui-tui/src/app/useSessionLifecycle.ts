...
import type { ScrollBoxHandle } from '@kova/ink'
import { evictInkCaches } from '@kova/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.KOVA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
