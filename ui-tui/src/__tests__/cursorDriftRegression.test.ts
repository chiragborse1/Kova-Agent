 ...
 *
 * Symptom: in `kova --tui`, typing into the composer until the input
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using kova --tui and as i type multiline my caret at the end will often ' +
