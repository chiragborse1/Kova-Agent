...
// ~/.kova. To exercise the real persistence path we clear that gate, point
// KOVA_HOME at a temp dir, and re-import the module fresh (path + enabled
...
describe('recordParentLifecycle', () => {
  ...
  beforeEach(() => {
    home = mkdtempSync(join(tmpdir(), 'kova-parentlog-'))
  })
