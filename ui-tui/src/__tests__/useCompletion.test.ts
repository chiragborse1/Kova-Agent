...
describe('completionRequestForInput', () => {
  ...
  it('does not route absolute paths through slash completion', () => {
    expect(
      completionRequestForInput('/home/d/Desktop/agenda/CrimsonRed/.kova/plans/2026-05-04-HANDOFF-NEXT.md')
    ).toMatchObject({
      method: 'complete.path',
      params: { word: '/home/d/Desktop/agenda/CrimsonRed/.kova/plans/2026-05-04-HANDOFF-NEXT.md' },
      replaceFrom: 0
    })
  })
