...
``_check_spotify_available()`` — when the user has not run ``kova auth
spotify``, the tools remain registered (so they appear in ``kova
...
The Spotify auth flow (``kova auth spotify``), CLI plumbing, and docs
