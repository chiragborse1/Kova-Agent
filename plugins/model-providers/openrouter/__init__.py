...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by kova_cli/models.py
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        if supports_reasoning:
            ...
            # model default to adaptive. See Kova-Agent#43432 (disable case)
            ...
            # live token-spend probe in Kova-Agent#43432). Route the existing
