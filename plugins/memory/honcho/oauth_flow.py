...
# The loopback redirect registered for the kova OAuth client. IP-literal so
...
_CALLBACK_HTML = (
    ...
    b"<div>Connected to Honcho. You can close this tab and return to kova.</div>"
)
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local KOVA_HOME override can't reach.
