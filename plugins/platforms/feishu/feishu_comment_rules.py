...
Config: ~/.kova/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.kova/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_kova_home()`` helper (KOVA_HOME-aware and
...
RULES_FILE = get_kova_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_kova_home() / "feishu_comment_pairing.json"
