...
# ``model_tools`` import time, so ``kova status``, ``kova chat``, etc.
...
#     fresh "kova is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # Persisted to ${KOVA_HOME}/google_chat_thread_counts.json so
        ...
        # they don't sit in the chat forever as "kova is thinking…".
    ...
    def _bot_id_cache_path(self) -> _Path:
        ...
        base = os.getenv("KOVA_HOME", str(_Path.home() / ".kova"))
    ...
    async def _dispatch_message(self, msg: Dict[str, Any], envelope: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if text.startswith("/setup-files") and event.source is not None:
                ...
                # ${KOVA_HOME}/google_chat_user_tokens/<sanitized>.json
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'kova is thinking…' marker message.
        ...
        "kova is thinking…" stuck in chat forever, plus one card that
        ...
        body: Dict[str, Any] = {"text": "kova is thinking…"}
        if thread_id:
            body["thread"] = {"name": thread_id}
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "kova is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "kova is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "kova is thinking…" card during any subsequent
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'kova-agent[google_chat]'",
        ...
        # the "kova is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'kova is thinking…' marker message "
