...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Kova Gateway adapter.

    Each inbound phone number gets its own kova session (multi-tenant).
...
# static dict in kova_cli/gateway.py, and the _send_sms dispatch in
