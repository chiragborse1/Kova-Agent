...
required — uses aiohttp which is already a kova dependency.
...
def interactive_setup() -> None:
    ...
    ``kova_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where kova delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # kova_cli/setup.py::_setup_mattermost function.
