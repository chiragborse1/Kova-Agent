# kova Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.kova/plugins/kova-achievements/state.json` (existing unlock state)
  - `~/.kova/plugins/kova-achievements/scan_snapshot.json` (new)
  - `~/.kova/plugins/kova-achievements/scan_checkpoint.json` (new)
