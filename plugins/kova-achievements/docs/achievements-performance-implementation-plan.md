# kova Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.kova/plugins/kova-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.kova/plugins/kova-achievements/scan_checkpoint.json`.
