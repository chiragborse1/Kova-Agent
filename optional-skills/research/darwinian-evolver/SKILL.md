...
import upstream classes into kova itself.
...
Open `~/.kova/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside kova core.
   Custom driver scripts under `~/.kova/skills/...` are user-side and fine.
