#!/usr/bin/env python3
"""
Hyperliquid CLI Tool for Kova Agent
-------------------------------------
...
def _resolve_user(user: Optional[str]) -> str:
    ...
    sys.exit(
        ...
        f"{DEFAULT_USER_ENV} in your environment or {_KOVA_HOME() / '.env'}."
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Hyperliquid CLI Tool for Kova Agent")
