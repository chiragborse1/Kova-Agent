---
name: kova-s6-container-supervision
description: Modify, debug, or extend the s6-overlay supervision tree inside the Kova Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern.
version: 1.0.0
author: Kova Agent
license: MIT
platforms: [linux]
...
metadata:
  kova:
    ...
    related_skills: [kova-agent, kova-agent-dev]
---
