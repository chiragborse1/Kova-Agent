#!/usr/bin/env python3
"""
stocks_client.py - Stock market data CLI tool for the Kova Agent project.
...
USER_AGENT = "Mozilla/5.0 (compatible; KovaAgent/1.0)"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="stocks_client",
        description="Stock & crypto market data CLI — Kova Agent",
