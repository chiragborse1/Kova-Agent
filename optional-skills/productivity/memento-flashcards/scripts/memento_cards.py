...
Data file: $KOVA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_KOVA_HOME = Path(os.environ.get("KOVA_HOME", Path.home() / ".kova"))
DATA_DIR = _KOVA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
