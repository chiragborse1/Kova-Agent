...
def test_new_command_rotates_KOVA_SESSION_ID_env_and_context(tmp_path):
    ...
    assert cli.session_id != old_session_id
    assert os.environ["KOVA_SESSION_ID"] == cli.session_id
    assert get_session_env("KOVA_SESSION_ID") == cli.session_id
