...
class TestHandleBusyCommand(unittest.TestCase):
    ...
    def test_no_args_shows_status(self):
        ...
        with (
            ...
            cli_mod.KovaCLI._handle_busy_command(stub, "/busy")
    ...
    def test_queue_argument_sets_queue_mode_and_saves(self):
        ...
        with (
            ...
            cli_mod.KovaCLI._handle_busy_command(stub, "/busy queue")
    ...
    def test_interrupt_argument_sets_interrupt_mode_and_saves(self):
        ...
        with (
            ...
            cli_mod.KovaCLI._handle_busy_command(stub, "/busy interrupt")
    ...
    def test_steer_argument_sets_steer_mode_and_saves(self):
        ...
        with (
            ...
            cli_mod.KovaCLI._handle_busy_command(stub, "/busy steer")
    ...
    def test_status_reports_steer_behavior(self):
        ...
        with (
            ...
            cli_mod.KovaCLI._handle_busy_command(stub, "/busy status")
    ...
    def test_invalid_argument_prints_usage(self):
        ...
        with (
            ...
            cli_mod.KovaCLI._handle_busy_command(stub, "/busy nonsense")
