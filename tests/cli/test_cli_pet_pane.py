...
we don't pay the full KovaCLI.__init__ cost; a synthetic spritesheet exercises
...
def boba_like(tmp_path, monkeypatch):
    """Install a synthetic pet into a temp KOVA_HOME and return its slug."""
...
def _make_cli():
    ...
    # Transient-beat + reasoning state (set by KovaCLI.__init__ in production).
    cli_obj._pet_event = ""
