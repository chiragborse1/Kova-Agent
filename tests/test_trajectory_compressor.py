...
def test_import_loads_env_from_KOVA_HOME(tmp_path, monkeypatch):
    home = tmp_path / ".kova"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-kova-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-kova-home"
