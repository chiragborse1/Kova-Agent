...
part of the bundled-plugins set; a stock kova-agent install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/kova_cli/test_web_server.py`` copies this directory
into ``$KOVA_HOME/plugins/example-dashboard/`` and forces the dashboard
