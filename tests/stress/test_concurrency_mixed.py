...
def worker_loop(worker_id: int, KOVA_HOME: str, result_file: str) -> None:
...
def reclaimer_loop(KOVA_HOME: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="KOVA_mixed_stress_")
    print(f"KOVA_HOME = {home}")
