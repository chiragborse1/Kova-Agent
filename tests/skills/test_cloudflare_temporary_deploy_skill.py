...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded kova-temp-hello (0.74 sec)\n"
        "Deployed kova-temp-hello triggers (0.42 sec)\n"
        "  https://kova-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://kova-temp-hello.serene-temple.workers.dev"
