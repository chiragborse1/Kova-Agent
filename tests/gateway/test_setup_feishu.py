"""Tests for _setup_feishu() in kova_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("kova_cli.config.save_env_value", side_effect=mock_save), \
         patch("kova_cli.config.get_env_value", side_effect=mock_get), \
         patch("kova_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("kova_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("kova_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("kova_cli.cli_output.print_header"), \
         patch("kova_cli.cli_output.print_info"), \
         patch("kova_cli.cli_output.print_success"), \
         patch("kova_cli.cli_output.print_warning"), \
         patch("kova_cli.cli_output.print_error"), \
