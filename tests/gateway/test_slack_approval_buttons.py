...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "KOVA_approve_once" in action_ids
        assert "KOVA_approve_session" in action_ids
        assert "KOVA_approve_always" in action_ids
        assert "KOVA_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "KOVA_deny", "value": "session-key"}
