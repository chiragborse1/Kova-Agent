...
class TestTelegramYamlConfigLoading:
    ...
    def test_top_level_reply_to_mode_off(self, tmp_path, monkeypatch):
        ...
        KOVA_HOME = self._write_config(tmp_path, "telegram:\n  reply_to_mode: off\n")
...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/chiragborse1/Kova-Agent/issues/23994:
    reply_to_mode 'off' was ignored when sending via kova-created DM topic
