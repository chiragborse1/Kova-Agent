...
- Warning respects KOVA_AGENT_TIMEOUT_WARNING env var
...
class TestStagedInactivityWarning:
    ...
    def test_warning_env_var_respected(self, monkeypatch):
        """KOVA_AGENT_TIMEOUT_WARNING env var is parsed correctly."""
        monkeypatch.setenv("KOVA_AGENT_TIMEOUT_WARNING", "600")
        _warning = float(os.getenv("KOVA_AGENT_TIMEOUT_WARNING", 900))
        assert _warning == 600.0

    def test_warning_zero_means_disabled(self, monkeypatch):
        """KOVA_AGENT_TIMEOUT_WARNING=0 disables the warning."""
        monkeypatch.setenv("KOVA_AGENT_TIMEOUT_WARNING", "0")
        _raw = float(os.getenv("KOVA_AGENT_TIMEOUT_WARNING", 900))
