...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.kova/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at kova_state import time, before pytest's KOVA_HOME monkeypatch
    fires — the autouse fixture's KOVA_HOME override doesn't help here.)
    """
    import kova_state
