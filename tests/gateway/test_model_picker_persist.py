...
closure the PR changed, against a real temp ``KOVA_HOME``.
"""
...
def _setup_isolated_home(tmp_path, monkeypatch, model_yaml_value):
    ...
    # save_config writes to ``get_kova_home() / config.yaml`` — point it here.
