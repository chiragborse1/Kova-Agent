...
async def test_non_internal_event_without_user_triggers_pairing(monkeypatch, tmp_path):
    ...
    # import time from whichever KOVA_HOME was set then. Per-test
    # KOVA_HOME redirection in conftest doesn't retroactively move it.
    ...
    # module-level dotenv in gateway/run.py from the real ~/.kova/.env).
