...
Q-B, exercises a real `Kova Gateway run`); these lock the unit contract.
"""
...
class TestMarkerContract:
    ...
    def test_path_respects_KOVA_HOME(self, home):
...
class TestInstantiationEpoch:
    ...
    def test_marker_from_prior_instantiation_reads_as_absent(self, home, monkeypatch):
        ...
        # container/VM instantiation survives on the durable KOVA_HOME volume
