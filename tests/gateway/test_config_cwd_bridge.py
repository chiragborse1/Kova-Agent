...
class TestTopLevelCwdAlias:
    ...
    def test_top_level_cwd_sets_terminal_cwd(self):
        cfg = {"cwd": "/home/kova/projects"}
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/kova/projects"
    ...
    def test_top_level_cwd_and_backend(self):
        cfg = {"backend": "local", "cwd": "/home/kova/projects"}
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/kova/projects"
    ...
    def test_nested_terminal_takes_precedence_over_top_level(self):
        ...
        cfg = {
            "cwd": "/should/not/use",
            "terminal": {"cwd": "/home/kova/real"},
        }
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/kova/real"
    ...
    def test_no_cwd_falls_back_to_messaging_cwd(self):
        cfg = {}
        result = _simulate_config_bridge(cfg, {"MESSAGING_CWD": "/home/kova/projects"})
        assert result["TERMINAL_CWD"] == "/home/kova/projects"
    ...
    def test_dot_cwd_triggers_messaging_fallback(self):
        ...
        cfg = {"cwd": "."}
        result = _simulate_config_bridge(cfg, {"MESSAGING_CWD": "/home/kova"})
        ...
        assert result["TERMINAL_CWD"] == "/home/kova"
