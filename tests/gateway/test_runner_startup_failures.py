...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("kova_logging.setup_logging", lambda KOVA_HOME, mode: tmp_path)
    monkeypatch.setattr("kova_logging._add_rotating_handler", lambda *args, **kwargs: None)
