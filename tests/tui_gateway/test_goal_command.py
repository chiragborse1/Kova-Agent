...
def test_moa_bare_returns_usage(server, session, KOVA_HOME):
    _write_moa_config(KOVA_HOME, """
moa:
...
def test_moa_arg_is_always_one_shot(server, session, KOVA_HOME):
...
def test_moa_non_preset_returns_one_shot_send(server, session, KOVA_HOME):
    _write_moa_config(KOVA_HOME, """
moa:
  default_preset: default
  presets:
