...
def test_junk_root_never_becomes_an_auto_project():
    # A session whose git root is KOVA_HOME (config/state) must not spawn a
    # phantom project; it falls through to flat Recents (unscoped). A real repo
    # alongside it still groups normally.
    resolve = _resolver(
        {
            "/home/me/.kova": ("/home/me/.kova", "/home/me/.kova"),
            "/www/app": ("/www/app", "/www/app"),
        }
    )
    junk = _session("/home/me/.kova", branch="main")
    real = _session("/www/app", branch="main")
    is_junk = lambda root: root == "/home/me/.kova"
...
def test_junk_root_is_dropped_from_the_discovered_tier():
    discovered = [{"root": "/home/me/.kova", "label": ".kova", "sessions": 0, "last_active": 9}]

    tree = pt.build_tree([], [], discovered, resolve=None, is_junk_root=lambda r: r == "/home/me/.kova")
