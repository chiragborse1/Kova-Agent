...
The unit tests in tests/kova_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned kova-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/kova")
from kova_cli.service_manager import S6ServiceManager
