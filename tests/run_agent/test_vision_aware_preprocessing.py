...
class TestModelSupportsVision:
    ...
    def test_top_level_model_override_wins(self):
        ...
        with patch("kova_cli.config.load_config", return_value={"model": {"supports_vision": True}}), \
    ...
    def test_override_false_disables_vision_for_models_dev_models(self):
        ...
        fake_caps = MagicMock()
        fake_caps.supports_vision = True
        with patch("kova_cli.config.load_config", return_value={"model": {"supports_vision": False}}), \
