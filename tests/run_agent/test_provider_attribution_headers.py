...
def test_openrouter_base_url_applies_or_headers(mock_openai):
    ...
    assert headers["HTTP-Referer"] == "https://github.com/chiragborse1/Kova-Agent"
...
def test_user_default_headers_win_over_provider_defaults(mock_openai):
    ...
    assert headers["HTTP-Referer"] == "https://github.com/chiragborse1/Kova-Agent"  # default preserved
