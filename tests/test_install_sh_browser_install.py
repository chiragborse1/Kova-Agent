...
Browser automation is optional. The installer should not leave kova
...
def test_install_script_does_not_autodetect_system_browser_on_path() -> None:
    ...
    assert "Skipping Playwright browser download; kova will use the system browser." not in text
