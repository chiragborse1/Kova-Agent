...
class TestOpenVikingSummaryUriNormalization:
    def test_normalize_summary_uri_maps_pseudo_files_to_parent_directory(self):
        assert OpenVikingMemoryProvider._normalize_summary_uri("viking://user/kova/.overview.md") == "viking://user/kova"
        ...
        assert OpenVikingMemoryProvider._normalize_summary_uri("viking://user/kova/memories/profile.md") == "viking://user/kova/memories/profile.md"
...
class TestOpenVikingSkillQuerySafety:
    ...
    def test_skill_markers_match_KOVA_scaffolding(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("KOVA_BUNDLES_DIR", str(bundles_dir))
...
class TestOpenVikingTurnConversion:
            ...
            turn = [
                ...
                },
                {
                    ...
                    "content": json.dumps({
                        "results": [
                            {
                                "uri": "viking://user/kova/memories/context",
    ...
    def test_messages_to_openviking_batch_adds_assistant_peer_id_when_requested(self):
        ...
        assert batch == [
            {"role": "user", "parts": [{"type": "text", "text": "hello"}]},
            {"role": "assistant", "parts": [{"type": "text", "text": "answer"}], "peer_id": "kova"},
        ]
...
class TestOpenVikingRead:
        ...
        provider._client = FakeVikingClient(
            {
                (
                    ...
                    (("uri", "viking://user/kova"),),
                ): {"result": {"content": "overview text"}},
            }
        )

        result = json.loads(provider._tool_read({"uri": "viking://user/kova/.overview.md", "level": "overview"}))

        assert result["uri"] == "viking://user/kova/.overview.md"
        assert result["resolved_uri"] == "viking://user/kova"
        ...
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/content/read",
                    (("uri", "viking://user/kova/memories/profile.md"),),
                ): {"result": "full text"},
            }
        )

        result = json.loads(provider._tool_read({"uri": "viking://user/kova/memories/profile.md", "level": "full"}))

        assert result["uri"] == "viking://user/kova/memories/profile.md"
        assert result["resolved_uri"] == "viking://user/kova/memories/profile.md"
    ...
    def test_read_accepts_uri_batch_and_caps_batch_full_content(self):
        provider = OpenVikingMemoryProvider()
        uris = [
            "viking://user/kova/memories/a.md",
            "viking://user/kova/memories/b.md",
            "viking://user/kova/memories/c.md",
            "viking://user/kova/memories/d.md",
        ]
        provider._client = FakeVikingClient(
            {
                (
    ...
    def test_read_deduplicates_uri_batch_and_keeps_errors_per_uri(self):
        provider = OpenVikingMemoryProvider()
        ok_uri = "viking://user/kova/memories/ok.md"
        bad_uri = "viking://user/kova/memories/bad.md"
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/content/read",
    ...
    def test_overview_file_uri_routes_straight_to_content_read_via_stat_probe(self):
        ...
        provider = OpenVikingMemoryProvider()
        file_uri = "viking://user/kova/memories/entities/mem_abc.md"
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/fs/stat",
    ...
    def test_overview_dir_uri_skips_stat_when_pseudo_summary(self):
        ...
        assert provider._client.calls == [
            ("/api/v1/content/overview", {"uri": "viking://user/kova"}),
        ]
    ...
    def test_overview_directory_uri_uses_stat_probe_then_overview(self):
        ...
        provider = OpenVikingMemoryProvider()
        dir_uri = "viking://user/kova/memories"
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/fs/stat",
    ...
    def test_summary_uri_error_does_not_fallback_and_raises(self):
        ...
        try:
            provider._tool_read({"uri": "viking://user/kova/.overview.md", "level": "overview"})
...
class TestOpenVikingAutoRecallPrefetch:
    def test_prefetch_e2e_sends_limit_and_reads_l2_content(self, monkeypatch):
                    ...
                    if payload.get("context_type") == "memory":
                        self._send_json({
                            "result": {
                                "memories": [
                                    {
                                        "uri": "viking://user/peers/kova/memories/e2e-full.md",
                                        "score": 0.9,
                                        "level": 2,
                                        "category": "events",
        ...
        monkeypatch.setenv("OPENVIKING_AGENT", "kova")
        ...
        assert records["reads"] == ["viking://user/peers/kova/memories/e2e-full.md"]
        ...
        assert all(headers.get("x-openviking-actor-peer") == "kova" for headers in normalized_headers)
        ...
        responses = {
            (
                ...
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/kova/memories/caroline.md",
                            "score": 0.9,
                            "level": 1,
                            "category": "profile",
        ...
        responses = {
            ...
            (
                ...
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/kova/memories/melanie-race.md",
                            "score": 0.9,
                            "level": 1,
                            "category": "events",
        ...
        responses = {
            ("/api/v1/search/search", "memory", "What should we recall?", "session-test"): {
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/kova/memories/keep.md",
                            "score": 0.22,
                            "level": 1,
                        ...
                        {
                            "uri": "viking://user/peers/kova/memories/drop.md",
                            "score": 0.12,
                            "level": 1,
                            "category": "preferences",
        ...
        responses = {
            ("/api/v1/search/search", "memory", "What should we recall?", "session-test"): {
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/kova/memories/too-large.md",
                            "score": 0.9,
                            "level": 1,
                            "category": "memory",
                        ...
                        {
                            "uri": "viking://user/peers/kova/memories/small.md",
                            "score": 0.8,
                            "level": 1,
                            "category": "memory",
        ...
        responses = {
            ("/api/v1/search/search", "memory", "What should we recall?", "session-test"): {
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/kova/memories/full.md",
                            "score": 0.9,
                            "level": 2,
                            "category": "events",
            ...
            ("/api/v1/content/read", "viking://user/peers/kova/memories/full.md"): {
...
class TestOpenVikingBrowse:
    def test_list_browse_unwraps_and_normalizes_entry_shapes(self):
        ...
        provider._client = FakeVikingClient(
            {
                (
                    ...
                    "result": {
                        "entries": [
                            {"name": "memories", "uri": "viking://user/kova/memories", "type": "dir"},
                            {"rel_path": "profile.md", "uri": "viking://user/kova/memories/profile.md", "isDir": False, "abstract": "Profile"},
                        ]
                    }
                },
            }
        ...
        result = json.loads(provider._tool_browse({"action": "list", "path": "viking://user/kova"}))

        assert result["path"] == "viking://user/kova"
        assert result["entries"] == [
            {"name": "memories", "uri": "viking://user/kova/memories", "type": "dir", "abstract": ""},
            {"name": "profile.md", "uri": "viking://user/kova/memories/profile.md", "type": "file", "abstract": "Profile"},
        ]
        assert provider._client.calls == [(
            "/api/v1/fs/ls",
            {"uri": "viking://user/kova"},
