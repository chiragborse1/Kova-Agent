...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, KOVA_HOME, tmp_path):
    ...
    def test_patch_on_lf_file_stays_lf(self, KOVA_HOME, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, KOVA_HOME, tmp_path):
...
class TestWriteFileCRLFPreservation:
    ...
    def test_new_file_written_as_is(self, KOVA_HOME, tmp_path):
    ...
    def test_overwrite_lf_file_stays_lf(self, KOVA_HOME, tmp_path):
