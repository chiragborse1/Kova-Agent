...
def test_default_gate_is_off(KOVA_HOME):
...
def test_invalid_subsystem_is_off(KOVA_HOME):
    from tools import write_approval as wa
...
def test_memory_gate_on_no_interactive_stages(KOVA_HOME):
...
def test_memory_gate_on_then_apply(KOVA_HOME):
...
def test_load_on_disk_store_honors_configured_char_limits(KOVA_HOME, monkeypatch):
...
def test_skill_gate_off_allows_create(KOVA_HOME):
...
def test_skill_gate_on_always_stages(KOVA_HOME):
...
def test_skill_create_diff_is_full_content(KOVA_HOME):
    from tools.skill_manager_tool import skill_manage
    from tools import write_approval as wa
    _set_approval("skills", True)
...
def test_pending_store_roundtrip(KOVA_HOME):
    from tools import write_approval as wa
...
def test_handle_pending_list_empty(KOVA_HOME):
...
def test_handle_reject(KOVA_HOME):
    from kova_cli.write_approval_commands import handle_pending_subcommand
    from tools import write_approval as wa
...
def test_handle_mode_alias_still_works(KOVA_HOME):
...
def test_handle_approval_invalid(KOVA_HOME):
    from kova_cli.write_approval_commands import handle_pending_subcommand
    from tools import write_approval as wa
...
def test_handle_unknown_subcommand_returns_none(KOVA_HOME):
    from kova_cli.write_approval_commands import handle_pending_subcommand
    from tools import write_approval as wa
...
def test_memory_inline_callback_error_stages(KOVA_HOME, approval_callback_cleanup):
...
def test_gateway_context_stages_not_prompts(KOVA_HOME, monkeypatch):
...
def test_skills_never_prompt_inline_even_with_callback(KOVA_HOME, approval_callback_cleanup):
