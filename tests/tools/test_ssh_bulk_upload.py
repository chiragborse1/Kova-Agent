...
class TestSSHBulkUpload:
    ...
    def test_mkdir_batched_into_single_call(self, mock_env, tmp_path):
        ...
        files = [
            (str(f1), "/home/testuser/.kova/skills/a.txt"),
            (str(f2), "/home/testuser/.kova/credentials/b.txt"),
        ]
        ...
        assert "/home/testuser/.kova/skills" in mkdir_str
        assert "/home/testuser/.kova/credentials" in mkdir_str
    ...
    def test_staging_symlinks_mirror_remote_layout(self, mock_env, tmp_path):
        ...
        files = [
            (str(f1), "/home/testuser/.kova/skills/my_skill.md"),
        ]
    ...
    def test_tar_pipe_commands(self, mock_env, tmp_path):
        ...
        files = [(str(f1), "/home/testuser/.kova/cache/x.txt")]
        ...
        # ssh: extract from stdin at ~/.kova, preserving existing dir modes (#17767)
        ssh_str = " ".join(ssh_cmd)
        assert "ssh" in ssh_str
        assert "tar xf -" in ssh_str
        assert "--no-overwrite-dir" in ssh_str
        assert "-C /home/testuser/.kova" in ssh_str
    ...
    def test_bulk_upload_never_stages_remote_home_prefix(self, mock_env, tmp_path):
        ...
        files = [(str(f1), "/home/testuser/.kova/cache/nested.txt")]
    ...
    def test_mkdir_failure_raises(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "y.txt"
        f1.write_text("y")
        files = [(str(f1), "/home/testuser/.kova/skills/y.txt")]
    ...
    def test_tar_create_failure_raises(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "z.txt"
        f1.write_text("z")
        files = [(str(f1), "/home/testuser/.kova/skills/z.txt")]
    ...
    def test_ssh_extract_failure_raises(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "w.txt"
        f1.write_text("w")
        files = [(str(f1), "/home/testuser/.kova/skills/w.txt")]
    ...
    def test_ssh_command_uses_control_socket(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "c.txt"
        f1.write_text("c")
        files = [(str(f1), "/home/testuser/.kova/cache/c.txt")]
    ...
    def test_custom_port_and_key_in_ssh_command(self, monkeypatch, tmp_path):
        ...
        f1 = tmp_path / "d.txt"
        f1.write_text("d")
        files = [(str(f1), "/home/u/.kova/skills/d.txt")]
    ...
    def test_parent_dirs_deduplicated(self, mock_env, tmp_path):
        ...
        files = [
            (str(f1), "/home/testuser/.kova/skills/a.txt"),
            (str(f2), "/home/testuser/.kova/skills/b.txt"),
            (str(f3), "/home/testuser/.kova/credentials/c.txt"),
        ]
        ...
        assert mkdir_str.count("/home/testuser/.kova/skills") == 1
        assert "/home/testuser/.kova/credentials" in mkdir_str
    ...
    def test_tar_stdout_closed_for_sigpipe(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "s.txt"
        f1.write_text("s")
        files = [(str(f1), "/home/testuser/.kova/skills/s.txt")]
    ...
    def test_timeout_kills_both_processes(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "t.txt"
        f1.write_text("t")
        files = [(str(f1), "/home/testuser/.kova/skills/t.txt")]
...
class TestSSHBulkUploadEdgeCases:
    ...
    def test_ssh_popen_failure_kills_tar(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "e.txt"
        f1.write_text("e")
        files = [(str(f1), "/home/testuser/.kova/skills/e.txt")]
