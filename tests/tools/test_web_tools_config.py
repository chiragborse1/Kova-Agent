...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_KOVA_HOME_override(self, tmp_path):
        """Auth lookup should read from KOVA_HOME/auth.json, not ~/.kova/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".kova").mkdir(parents=True)
