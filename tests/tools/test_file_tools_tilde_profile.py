...
See: https://github.com/chiragborse1/Kova-Agent/issues/48552
"""
...
class TestExpandTilde:
    ...
    def test_tilde_expands_to_profile_home(self):
        ...
        with patch("kova_constants.get_subprocess_home", return_value="/opt/data/profiles/coder/home"):
    ...
    def test_falls_back_when_no_profile_home(self):
        ...
        with patch("kova_constants.get_subprocess_home", return_value=None):
...
class TestResolvePathUsesProfileHome:
    ...
    def test_relative_tilde_resolves_to_profile_home(self, tmp_path, monkeypatch):
        ...
        with patch("kova_constants.get_subprocess_home", return_value=str(profile_home)):
