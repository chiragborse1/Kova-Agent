"""Regression test for the ``KovaMCPOAuthProvider.async_auth_flow`` bidirectional
generator bridge.
...
@pytest.mark.asyncio
async def test_KOVA_provider_forwards_asend_values(tmp_path, monkeypatch):
...
@pytest.mark.asyncio
async def test_KOVA_provider_forwards_401_triggers_refresh(tmp_path, monkeypatch):
