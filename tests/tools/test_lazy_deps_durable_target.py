...
class TestGatingWithTarget:
    """``KOVA_DISABLE_LAZY_INSTALLS=1`` must STOP blocking once a durable
...
@pytest.mark.skipif(
    os.environ.get("KOVA_RUN_NETWORK_TESTS") != "1",
    reason="opt-in real-install test (set KOVA_RUN_NETWORK_TESTS=1); CI runs "
