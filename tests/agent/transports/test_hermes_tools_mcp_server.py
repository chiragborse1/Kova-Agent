"""Tests for the kova-tools-as-MCP server module surface.
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import kova_tools_mcp_server as m
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from agent.transports.kova_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
    ...
    def test_expected_KOVA_specific_tools_listed(self):
        """The kova-specific tools should be present so users on the
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `kova chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.kova_tools_mcp_server as m
