...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_KOVA_user(self):
        """Without user_id or config override, should default to 'kova-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "kova-user"
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"KOVA_HOME": "/tmp/test_kova"}):
