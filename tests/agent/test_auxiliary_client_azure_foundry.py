...
that delegates to :func:`kova_cli.runtime_provider._resolve_azure_foundry_runtime`
...
class TestResolveProviderClientAzureFoundry:
    ...
    def test_warns_and_returns_none_on_failure(
        ...
        clear warning pointing at ``kova doctor``."""
        import logging
        ...
        assert resolved is None
        assert any(
            "azure-foundry" in rec.message and "kova doctor" in rec.message
