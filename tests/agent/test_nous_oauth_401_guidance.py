...
to a generic "Your API key was rejected... run kova setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "kova setup".
    assert "kova portal" in source
