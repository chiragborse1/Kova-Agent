...
def test_build_welcome_banner_title_is_hyperlinked_to_release():
    ...
    import kova_cli.banner as _banner
    import model_tools as _mt
    import tools.mcp_tool as _mcp

    _banner._latest_release_cache = None
    tag_url = ("v2026.4.23", "https://github.com/chiragborse1/Kova-Agent/releases/tag/v2026.4.23")
    ...
    assert "Kova Agent v" in raw, "Version label missing from title"
