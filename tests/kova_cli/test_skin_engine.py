"""Tests for kova_cli.skin_engine — the data-driven skin/theme system."""
...
class TestBuiltinSkins:
    ...
    def test_all_builtin_skins_have_complete_colors(self):
        from kova_cli.skin_engine import _BUILTIN_SKINS, _build_skin_config
...
class TestSkinManagement:
    def test_set_active_skin(self):
        from kova_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
    ...
    def test_init_skin_from_config(self):
        from kova_cli.skin_engine import init_skin_from_config, get_active_skin_name
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        # Patch skins dir
        monkeypatch.setattr("kova_cli.skin_engine._skins_dir", lambda: skins_dir)
...
class TestCliBrandingHelpers:
    ...
    def test_active_prompt_symbol_ares(self):
        from kova_cli.skin_engine import set_active_skin, get_active_prompt_symbol

        set_active_skin("ares")
        assert get_active_prompt_symbol() == "⚔ "

    def test_active_help_header_ares(self):
        from kova_cli.skin_engine import set_active_skin, get_active_help_header

        set_active_skin("ares")
        assert get_active_help_header() == "(⚔) Available Commands"

    def test_active_goodbye_ares(self):
        from kova_cli.skin_engine import set_active_skin, get_active_goodbye

        set_active_skin("ares")
        assert get_active_goodbye() == "Farewell, warrior! ⚔"

    def test_prompt_toolkit_style_overrides_cover_tui_classes(self):
        from kova_cli.skin_engine import set_active_skin, get_prompt_toolkit_style_overrides
        set_active_skin("ares")
    ...
    def test_prompt_toolkit_style_overrides_use_skin_colors(self):
        from kova_cli.skin_engine import (
            set_active_skin,
            get_active_skin,
