"""Tests for the specifier module + `kova kanban specify` CLI surface.
...
from kova_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `kova kanban …` argparse surface directly."""
