...
from kova_cli.dashboard_auth.cookies import SESSION_AT_COOKIE, SESSION_RT_COOKIE
from kova_cli.dashboard_auth.login_page import render_login_html
from kova_cli.dashboard_auth.routes import _reset_password_rate_limit
...
class PasswordProvider(DashboardAuthProvider):
    ...
    def refresh_session(self, *, refresh_token: str) -> Session:
        from kova_cli.dashboard_auth import RefreshExpiredError
