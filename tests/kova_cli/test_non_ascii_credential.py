...
from kova_cli.config import _check_non_ascii_credential
...
class TestEnvLoaderSanitization:
    ...
    def test_strips_non_ascii_from_api_key(self, monkeypatch):
        from kova_cli.env_loader import _sanitize_loaded_credentials, _WARNED_KEYS
    ...
    def test_ignores_non_credential_vars(self, monkeypatch):
        from kova_cli.env_loader import _sanitize_loaded_credentials
