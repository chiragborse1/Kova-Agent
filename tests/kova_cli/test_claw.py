...
from kova_cli import claw as claw_mod
...
class TestCmdMigrate:
    ...
    def test_full_preset_does_not_enable_secrets_silently(self, tmp_path, capsys):
        ...
        even under the 'full' preset.  This mirrors OpenClaw's migrate-kova
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.kova/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.kova/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.kova/migration/openclaw/20250312T120000",
        }
