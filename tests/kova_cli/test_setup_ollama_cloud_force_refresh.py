"""Regression: ``kova setup`` for the ollama-cloud provider must force-refresh
...
def test_setup_ollama_cloud_passes_force_refresh(monkeypatch):
    ...
    # extracted from main.py into kova_cli/model_setup_flows.py (god-file
    # decomposition Phase 2). Inspect the module the code now lives in.
    import kova_cli.model_setup_flows as flows_mod
    import inspect
