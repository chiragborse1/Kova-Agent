"""Tests for the interactive session browser (`kova sessions browse`).
...
from kova_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """kova sessions browse should be parseable."""
