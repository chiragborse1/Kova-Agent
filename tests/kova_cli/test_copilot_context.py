...
class TestGetCopilotModelContext:
    ...
    @patch("kova_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("kova_cli.models.fetch_github_model_catalog", return_value=None)
    def test_returns_none_when_catalog_unavailable(self, mock_fetch):
        assert get_copilot_model_context("gpt-4.1") is None

    @patch("kova_cli.models.fetch_github_model_catalog", return_value=[])
