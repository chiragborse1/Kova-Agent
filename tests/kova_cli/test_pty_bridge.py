"""Unit tests for kova_cli.pty_bridge — PTY spawning + byte forwarding.
...
class TestClampDimension:
    def test_clamps_above_max(self):
        from kova_cli.pty_bridge import _MAX_COLS, _MAX_ROWS, _clamp_dimension

        assert _clamp_dimension(131072, _MAX_COLS) == _MAX_COLS
        assert _clamp_dimension(131072, _MAX_ROWS) == _MAX_ROWS

    def test_floors_at_one(self):
        from kova_cli.pty_bridge import _MAX_COLS, _clamp_dimension
