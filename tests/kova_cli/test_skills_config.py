"""Tests for kova_cli/skills_config.py and skills_tool disabled filtering."""
...
class TestSaveDisabledSkills:
    @patch("kova_cli.skills_config.save_config")
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from kova_cli.skills_config import _get_categories
        skills = [
