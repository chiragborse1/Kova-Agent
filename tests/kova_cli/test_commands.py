...
class TestSlackAppManifest:
    """Generated Slack app manifest (used by `kova slack manifest`)."""
...
class TestSubcommandCompletion:
    ...
    def test_tools_enable_completes_toolset_names(self, monkeypatch):
        ...
        from kova_cli import commands as commands_mod
        ...
        monkeypatch.setattr(
            "kova_cli.tools_config._get_plugin_toolset_keys",
            lambda: set(),
        )
...
from kova_cli.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch kova_cli.plugins.get_plugin_commands() to a fixed dict."""
        from kova_cli import plugins as _plugins_mod
