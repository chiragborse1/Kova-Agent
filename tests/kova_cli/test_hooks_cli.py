"""Tests for the ``kova hooks`` CLI subcommand."""
...
from kova_cli import hooks as hooks_cli
...
class TestHooksDoctor:
    ...
    def test_unallowlisted_script_is_not_executed(self, tmp_path):
        """Regression for M4: `kova hooks doctor` used to run every
