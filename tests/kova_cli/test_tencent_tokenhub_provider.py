...
# =============================================================================
# CANONICAL_PROVIDERS (kova model picker)
# =============================================================================
...
class TestTencentInOpenRouterAndNous:
    ...
    def test_in_openrouter_fallback(self):
        from kova_cli.models import OPENROUTER_MODELS
...
class TestTencentTokenhubDoctor:
    """Verify kova doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``kova model`` routes it through the generic api_key_provider flow.
        """
        import inspect
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from kova_cli.models import _KNOWN_PROVIDER_NAMES
