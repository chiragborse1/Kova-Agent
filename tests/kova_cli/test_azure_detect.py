"""Tests for kova_cli.azure_detect — transport & model auto-detection."""
...
def test_http_get_json_on_urlerror_returns_zero_none():
    ...
    import urllib.error
    with patch("kova_cli.azure_detect.urllib_request.urlopen",
...
def test_http_get_json_on_http_error_returns_code_none():
    ...
    with patch("kova_cli.azure_detect.urllib_request.urlopen", side_effect=err):
