...
the *mutation* side: `kova plugins enable/disable` must resolve a bare name
...
class TestResolvePluginKey:
    ...
    def test_full_key_resolves_to_itself(self, mock_user, mock_bundled, nested_plugin_env):
        from kova_cli.plugins_cmd import _resolve_plugin_key
...
class TestEnableDisableNested:
    @patch("kova_cli.plugins.get_bundled_plugins_dir")
    @patch("kova_cli.plugins_cmd._plugins_dir")
    @patch("kova_cli.plugins_cmd._save_disabled_set")
    @patch("kova_cli.plugins_cmd._save_enabled_set")
    ...
    def test_enable_bare_name_writes_key(
        ...
        from kova_cli.plugins_cmd import cmd_enable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
    ...
    def test_disable_bare_name_writes_key_and_clears_alias(
        ...
        from kova_cli.plugins_cmd import cmd_disable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
