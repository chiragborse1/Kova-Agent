"""Tests for `kova curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import kova_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated KOVA_HOME with real agent-created skills on disk."""
    home = tmp_path / ".kova"
    skills = home / "skills"
    ...
    from kova_cli import curator as curator_cli
