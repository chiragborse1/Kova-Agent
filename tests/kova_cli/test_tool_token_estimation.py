...
def test_estimate_tool_tokens_returns_positive_counts():
    ...
    from kova_cli.tools_config import _estimate_tool_tokens
...
def test_prompt_toolset_checklist_passes_status_fn(monkeypatch):
    ...
    monkeypatch.setattr("kova_cli.curses_ui.curses_checklist", fake_checklist)
...
def test_status_fn_returns_formatted_token_count(monkeypatch):
    ...
    import kova_cli.tools_config as tc
    from kova_cli.tools_config import CONFIGURABLE_TOOLSETS
...
def test_curses_checklist_numbered_fallback_shows_status(monkeypatch, capsys):
    ...
    from kova_cli.curses_ui import _numbered_fallback
