...
Simulates a slow kova_cli.gateway import (15-30 s on a fresh Windows install
...
1. _lifespan fire-and-forget: patched _warm_gateway_module sleeps N seconds in
   ...
   blocked, KOVA_DASHBOARD_READY would fire immediately).
...
import kova_cli.web_server as web_server_mod
...
def test_lifespan_warmup_is_nonblocking():
    ...
    KOVA_DASHBOARD_READY would have fired without delay.
    """
