...
def test_top_level_skills_flag_defaults_to_chat(monkeypatch):
    ...
    assert captured == {
        "skills": ["kova-agent-dev,github-auth"],
        "command": None,
    }
...
def test_chat_subcommand_accepts_skills_flag(monkeypatch):
    ...
    monkeypatch.setattr(
        sys,
        "argv",
        ["kova", "chat", "-s", "github-auth", "-q", "hello"],
    )
...
def test_chat_subcommand_accepts_image_flag(monkeypatch):
    ...
    monkeypatch.setattr(
        sys,
        "argv",
        ["kova", "chat", "-q", "hello", "--image", "~/storage/shared/Pictures/cat.png"],
    )
