"""Test the platform-branched PTY bridge import in kova_cli.web_server.
...
def test_web_server_uses_win_pty_bridge_on_windows():
    ...
    from kova_cli.win_pty_bridge import WinPtyBridge
    ...
    from kova_cli.win_pty_bridge import PtyUnavailableError as WinErr
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from kova_cli.pty_bridge import PtyBridge as PosixBridge
    from kova_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    #       try:
    #           from kova_cli.win_pty_bridge import WinPtyBridge as PtyBridge, ...
    #       except ImportError:
    #           PtyBridge = None
    #           ...
    #   else:
    ...
    assert "from kova_cli.win_pty_bridge import" in src
    assert "from kova_cli.pty_bridge import" in src
