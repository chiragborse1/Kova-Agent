...
def test_prompt_toolkit_model_picker_defers_confirmation_off_key_handler(monkeypatch):
    ...
    self_._close_model_picker = _bound(cli_mod.KovaCLI._close_model_picker, self_)
    ...
    _bound(cli_mod.KovaCLI._handle_model_picker_selection, self_)(persist_global=True)
