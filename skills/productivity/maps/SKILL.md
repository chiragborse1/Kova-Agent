...
Script path: `~/.kova/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=~/.kova/skills/maps/scripts/maps_client.py
```
...
```bash
python3 ~/.kova/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python3 ~/.kova/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
