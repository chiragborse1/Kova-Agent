...
def install_deps():
    ...
    # Fallback: the interpreter has no pip (the kova Docker image's venv is
    ...
    print(
        "On environments without pip (e.g. Nix, or the kova Docker image's "
        "uv-managed venv), install the optional extra instead:"
    )
    print("  pip install 'kova-agent[google]'")
