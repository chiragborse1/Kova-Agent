...
| File operations | Bash commands | kova file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains kova-specific adaptations.
