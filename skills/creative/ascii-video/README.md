...
Built for [Kova Agent](https://github.com/chiragborse1/Kova-Agent). Usable in any coding agent. Canonical source lives here; synced to [`chiragborse1/Kova-Agent/skills/creative/ascii-video`](https://github.com/chiragborse1/Kova-Agent/tree/main/skills/creative/ascii-video) via PR.
