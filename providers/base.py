...
def _profile_user_agent() -> str:
    """Return a ``kova-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from kova_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"kova-cli/{_ver}"
    except Exception:
        return "kova-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # kova-cli UA so the catalog endpoint is reachable.
