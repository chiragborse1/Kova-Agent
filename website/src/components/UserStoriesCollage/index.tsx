  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Kova Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use kova &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/chiragborse1/Kova-Agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
