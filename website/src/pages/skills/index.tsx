        ...
        {expanded && (
          <div className={styles.cardDetail}>
            ...
            <div className={styles.installHint}>
              <code>{skill.installCmd || `kova skills install ${skill.name}`}</code>
              <CopyButton
                text={skill.installCmd || `kova skills install ${skill.name}`}
              />
            </div>
...
export default function SkillsDashboard() {
  ...
  return (
    <Layout
      title="Skills Hub"
      description="Browse all skills and plugins available for Kova Agent"
    >
      <div className={styles.page}>
        <header className={styles.hero}>
          <div className={styles.heroGlow} />
          <div className={styles.heroContent}>
            <p className={styles.heroEyebrow}>Kova Agent</p>
