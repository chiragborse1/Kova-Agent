...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Kova CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`kova-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-kova-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/kova-agent-skill-authoring` |
