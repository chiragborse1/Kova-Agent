...
description: "Build wrapper CLIs that extend the kova TUI with custom widgets, keybindings, and layout changes"
---
...
Called after kova registers its own keybindings and before the layout is built. Add your keybindings to `kb`.
