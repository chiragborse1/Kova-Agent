...
Multiple kova processes (gateway + CLI sessions + worktree agents) share one
...
`~/.kova/` by default, or the value of `KOVA_HOME` environment variable.
