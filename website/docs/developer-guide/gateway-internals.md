...
- **Explicit target delivery** — `send_message` tool specifying `telegram:-1001234567890`, or the [`kova send` CLI](/guides/pipe-script-output) wrapping the same tool for shell scripts
