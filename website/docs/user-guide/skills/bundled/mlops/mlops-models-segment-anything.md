...
# Load model
sam = sam_model_registry["vit_h"](https://github.com/chiragborse1/Kova-Agent/blob/main/skills/mlops\models\segment-anything/checkpoint="sam_vit_h_4b8939.pth")
sam.to(device="cuda")
...
sam = sam_model_registry["vit_b"](https://github.com/chiragborse1/Kova-Agent/blob/main/skills/mlops\models\segment-anything/checkpoint="sam_vit_b_01ec64.pth")
...
- **[Advanced Usage](https://github.com/chiragborse1/Kova-Agent/blob/main/skills/mlops\models\segment-anything/references/advanced-usage.md)** - Batching, fine-tuning, integration
- **[Troubleshooting](https://github.com/chiragborse1/Kova-Agent/blob/main/skills/mlops\models\segment-anything/references/troubleshooting.md)** - Common issues and solutions
