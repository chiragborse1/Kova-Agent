...
| Version | `1.0.0` |
| Author | Kova Agent + Teknium (design systems sourced from VoltAgent/awesome-design-md) |
| License | MIT |
...
Each template includes a **kova Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's kova notes -->
