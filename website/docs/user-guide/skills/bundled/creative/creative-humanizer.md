...
| Version | `2.5.1` |
| Author | Siqi Chen (@blader, https://github.com/blader/humanizer), ported by Kova Agent |
| License | MIT |
...
Also apply this skill to **your own** output when writing user-facing prose — release notes, PR descriptions, documentation, long-form explanations, summaries. kova's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in kova
