...
Set your Tenor API key in your environment (add to `${KOVA_HOME:-~/.kova}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/chiragborse1/Kova-Agent/blob/main/skills/media\gif-search/url)`
