...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/security/oss-forensics` |
...
> resolve `SKILL_DIR` to the actual path — e.g. `~/.kova/skills/security/oss-forensics/`
...
**Reference**: See [evidence-types.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/evidence-types.md) for IOC taxonomy.
...
**Reference**: See [recovery-techniques.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/recovery-techniques.md) for accessing force-pushed commits.
...
**Reference**: See [evidence-types.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/evidence-types.md) for GH event types.
...
**Reference**: See [github-archive-guide.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/github-archive-guide.md) for CDX API parameters.
...
**Reference**: See [github-archive-guide.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/github-archive-guide.md) for all 12 event types and query patterns.
...
- Recover force-pushed commits using 3 methods (see [recovery-techniques.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/recovery-techniques.md))
...
**Common hypothesis templates** (see [investigation-templates.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/investigation-templates.md)):
...
Populate `investigation-report.md` using the template in [forensic-report.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/templates/forensic-report.md).
...
- [github-archive-guide.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/github-archive-guide.md) — BigQuery queries, CDX API, 12 event types
- [evidence-types.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/evidence-types.md) — IOC taxonomy, evidence source types, observation types
- [recovery-techniques.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/recovery-techniques.md) — Recovering deleted commits, PRs, issues
- [investigation-templates.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/investigation-templates.md) — Pre-built hypothesis templates per attack type
- [evidence-store.py](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/scripts/evidence-store.py) — CLI tool for managing the evidence JSON store
- [forensic-report.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/templates/forensic-report.md) — Structured report template
