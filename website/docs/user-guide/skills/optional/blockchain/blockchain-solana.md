...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Kova Agent |
| License | MIT |
...
Helper script path: ~/.kova/skills/blockchain/solana/scripts/solana_client.py
...
python3 ~/.kova/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.kova/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.kova/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.kova/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.kova/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.kova/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
