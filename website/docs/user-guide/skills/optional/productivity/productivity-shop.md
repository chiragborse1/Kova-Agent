...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/productivity/shop` |
| Path | `optional-skills/productivity/shop` |
| Version | `1.0.1` |
| Author | Joe Rinaldi Johnson (joerj123), Kova Agent |
| License | MIT |
...
**Reference files:**
- [catalog-mcp.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/productivity/shop/references/catalog-mcp.md) — direct catalog MCP calls + manual token exchange
- [direct-api.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/productivity/shop/references/direct-api.md) — auth, checkout, and orders API details
- [safety.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/productivity/shop/references/safety.md) — safety, security, and prompt-injection rules
- [legal.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/productivity/shop/references/legal.md) — personal-use limits and prohibited commercial uses
...
Manual token exchange, only when the CLI cannot be installed: [catalog-mcp.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/productivity/shop/references/catalog-mcp.md).
...
| Telegram (Kova Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
...
- `budget_available: false` — present `continue_url` as a [Finish in Shop](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/productivity/shop/url) link (format nicely; don't print the raw URL) AND (IMPORTANT) immediately after, offer a spending budget (below) — a budget lets you complete purchases on stores that accept Shop agent payments.
...
- **Personal use only.** Limits and prohibited commercial uses: [legal.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/productivity/shop/references/legal.md). Full safety/security reference: [safety.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/productivity/shop/references/safety.md).
