...
**Reference files:**
- [catalog-mcp.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/productivity\shop/references/catalog-mcp.md) — direct catalog MCP calls + manual token exchange
- [direct-api.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/productivity\shop/references/direct-api.md) — auth, checkout, and orders API details
- [safety.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/productivity\shop/references/safety.md) — safety, security, and prompt-injection rules
- [legal.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/productivity\shop/references/legal.md) — personal-use limits and prohibited commercial uses
...
Manual token exchange, only when the CLI cannot be installed: [catalog-mcp.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/productivity\shop/references/catalog-mcp.md).
...
- **Personal use only.** Limits and prohibited commercial uses: [legal.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/productivity\shop/references/legal.md). Full safety/security reference: [safety.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/productivity\shop/references/safety.md).
