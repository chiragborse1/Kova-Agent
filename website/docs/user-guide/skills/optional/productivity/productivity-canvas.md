...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Kova Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${KOVA_HOME:-~/.kova}/.env`:
