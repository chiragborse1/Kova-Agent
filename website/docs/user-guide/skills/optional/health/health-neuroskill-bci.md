...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/health/neuroskill-bci` |
...
Connect kova to a running [NeuroSkill](https://neuroskill.com/) instance to read
