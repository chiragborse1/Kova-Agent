...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.kova/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.kova/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — kova installs package this)
