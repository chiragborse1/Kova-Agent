...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/creative/baoyu-comic` |
...
Adapted from [baoyu-comic](https://github.com/JimLiu/baoyu-skills) for Kova Agent's tool ecosystem.
...
kova' `image_generate` tool is **prompt-only** — it accepts a text prompt and an aspect ratio, and returns an image URL. It does **NOT** accept reference images. When the user supplies a reference image, use it to **extract traits in text** that get embedded in every page prompt:
...
Details: [references/partial-workflows.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/partial-workflows.md)
...
- **Compatibility matrix** and **content-signal → preset** table live in [references/auto-selection.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/auto-selection.md). Read it before recommending combinations in Step 2.
...
Use kova' built-in `image_generate` tool for all image rendering. Its schema accepts only `prompt` and `aspect_ratio` (`landscape` | `portrait` | `square`); it **returns a URL**, not a local file. Every generated page or character sheet must therefore be downloaded to the output directory.
...
Full step-by-step workflow (analysis, storyboard, review gates, regeneration variants): [references/workflow.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/workflow.md).

## References

**Core Templates**:
- [analysis-framework.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/analysis-framework.md) - Deep content analysis
- [character-template.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/character-template.md) - Character definition format
- [storyboard-template.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/storyboard-template.md) - Storyboard structure
- [ohmsha-guide.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/ohmsha-guide.md) - Ohmsha manga specifics
...
**Workflow**:
- [workflow.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/workflow.md) - Full workflow details
- [auto-selection.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/auto-selection.md) - Content signal analysis
- [partial-workflows.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/creative/baoyu-comic/references/partial-workflows.md) - Partial workflow options
