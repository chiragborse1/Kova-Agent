...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/finance/dcf-model` |
...
**If you encounter errors or unreasonable results, read [TROUBLESHOOTING.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/finance\dcf-model/TROUBLESHOOTING.md) for detailed debugging guidance.**
...
3. **Check output**:
   ...
   - If `status` is `"errors_found"` → Check `error_summary` and read [TROUBLESHOOTING.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/finance\dcf-model/TROUBLESHOOTING.md) for debugging guidance
