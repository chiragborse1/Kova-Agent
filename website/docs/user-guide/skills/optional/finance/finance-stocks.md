...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Kova Agent |
| License | MIT |
...
```
SCRIPT=~/.kova/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.kova/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
