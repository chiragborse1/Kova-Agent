...
- [`path/to/main.py`](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/<link>) — <what runs when you start it>
- [`path/to/cli.py`](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/<link>) — <CLI surface>

## High-Level Architecture

<2-3 sentences. Detail goes in architecture.md.>

See [architecture.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/architecture.md).

## Module Map

| Module | Purpose |
|---|---|
| [`<module>`](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/modules/<module>.md) | <one-line purpose> |

## Getting Started

See [getting-started.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/getting-started.md).
````
...
- **<Component>** — <1-2 sentences>. See [`modules/<module>.md`](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/modules/<module>.md).
...
1. **<Step>** — [`<file>`](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/<link>)
2. **<Step>** — [`<file>`](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/<link>)
...
- [`<module>/<file>`](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/<link>) — <what it does>
...
1. **User input** — [`cli.py:KovaCLI.run_session`](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/<link>)
2. **Message dispatch** — [`run_agent.py:AIAgent.chat`](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/<link>)
````
...
- Architecture: [architecture.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/architecture.md)
- Module reference: [README.md#module-map](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/software-development\code-wiki/README.md#module-map)
````
