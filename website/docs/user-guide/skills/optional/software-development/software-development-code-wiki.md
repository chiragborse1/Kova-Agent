...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/software-development/code-wiki` |
...
Invoke through the `terminal` tool from the target repo's root, then use `read_file` / `search_files` / `write_file` to produce the wiki. Default output location is `~/.kova/wikis/<repo-name>/`. Only write into the repo (`docs/wiki/`) when the user explicitly requests it.
...
```bash
OUTPUT_DIR="$HOME/.kova/wikis/$REPO_NAME"
...
- [`path/to/main.py`](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/<link>) — <what runs when you start it>
- [`path/to/cli.py`](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/<link>) — <CLI surface>

## High-Level Architecture

<2-3 sentences. Detail goes in architecture.md.>

See [architecture.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/architecture.md).

## Module Map

| Module | Purpose |
|---|---|
| [`<module>`](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/modules/<module>.md) | <one-line purpose> |

## Getting Started

See [getting-started.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/getting-started.md).
````
...
- **<Component>** — <1-2 sentences>. See [`modules/<module>.md`](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/modules/<module>.md).
...
1. **<Step>** — [`<file>`](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
2. **<Step>** — [`<file>`](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
...
- [`<module>/<file>`](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/<link>) — <what it does>
...
1. **User input** — [`cli.py:KovaCLI.run_session`](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
2. **Message dispatch** — [`run_agent.py:AIAgent.chat`](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
````
...
- Architecture: [architecture.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/architecture.md)
- Module reference: [README.md#module-map](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/software-development/code-wiki/README.md#module-map)
````
...
```
Generated wiki at ~/.kova/wikis/<repo-name>/:
...
- **In-repo output without asking.** Default is `~/.kova/wikis/`. Only write into the repo when the user explicitly requests it.
