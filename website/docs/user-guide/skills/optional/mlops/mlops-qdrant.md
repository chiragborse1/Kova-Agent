...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/mlops\qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/mlops\qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
