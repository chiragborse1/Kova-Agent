...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/mlops/simpo` |
...
**Loss functions**: See [references/loss-functions.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/mlops\simpo/references/loss-functions.md) for sigmoid vs hinge loss, mathematical formulations, and when to use each.

**Hyperparameter tuning**: See [references/hyperparameters.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/mlops\simpo/references/hyperparameters.md) for beta, gamma, learning rate selection guide, and model-size-specific recommendations.

**Dataset preparation**: See [references/datasets.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/mlops\simpo/references/datasets.md) for preference data formats, quality filtering, and custom dataset creation.
