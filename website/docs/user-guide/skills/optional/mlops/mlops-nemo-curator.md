...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/mlops/nemo-curator` |
...
- **[Filtering Guide](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/nemo-curator/references/filtering.md)** - 30+ quality filters, heuristics
- **[Deduplication Guide](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/nemo-curator/references/deduplication.md)** - Exact, fuzzy, semantic methods
