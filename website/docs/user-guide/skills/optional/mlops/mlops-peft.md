...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/mlops\peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/mlops\peft/references/troubleshooting.md)** - Common errors, debugging, optimization
