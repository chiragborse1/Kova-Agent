...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/mlops/pytorch-lightning` |
...
**Callbacks**: See [references/callbacks.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/pytorch-lightning/references/callbacks.md) for EarlyStopping, ModelCheckpoint, custom callbacks, and callback hooks.

**Distributed strategies**: See [references/distributed.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/pytorch-lightning/references/distributed.md) for DDP, FSDP, DeepSpeed ZeRO integration, multi-node setup.

**Hyperparameter tuning**: See [references/hyperparameter-tuning.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/pytorch-lightning/references/hyperparameter-tuning.md) for integration with Optuna, Ray Tune, and WandB sweeps.
