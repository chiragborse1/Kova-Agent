...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/mlops/flash-attention` |
...
**Integration with HuggingFace Transformers**: See [references/transformers-integration.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/mlops\flash-attention/references/transformers-integration.md) for enabling Flash Attention in BERT, GPT, Llama models.

**Performance benchmarks**: See [references/benchmarks.md](https://github.com/chiragborse1/Kova-Agent/blob/main/optional-skills/mlops\flash-attention/references/benchmarks.md) for detailed speed and memory comparisons across GPUs and sequence lengths.
