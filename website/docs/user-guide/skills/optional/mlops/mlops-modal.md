...
| | |
|---|---|
| Source | Optional — install with `kova skills install official/mlops/modal` |
...
- **[Advanced Usage](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
- **[Troubleshooting](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - Common issues and solutions
