...
`node_modules` tree — kova installs both packages together when you
run `kova lsp install typescript` or auto-install fires on first
use.
...
Servers are kept alive for the life of the kova process. There's
