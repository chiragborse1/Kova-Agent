---
sidebar_position: 7
title: "Use SOUL.md with kova"
description: "How to use SOUL.md to shape Kova Agent's default voice, what belongs there, and how it differs from AGENTS.md and /personality"
---

# Use SOUL.md with kova

`SOUL.md` is the **primary identity** for your kova instance. It's the first thing in the system prompt — it defines who the agent is, how it speaks, and what it avoids.

If you want kova to feel like the same assistant every time you talk to it — or if you want to replace the kova persona entirely with your own — this is the file to use.
...
- personality
- communication style
- how direct or warm kova should be
- what kova should avoid stylistically
- how kova should relate to uncertainty, disagreement, and ambiguity

In short:
- `SOUL.md` is about who kova is and how kova speaks
...
kova automatically seeds a starter `SOUL.md` for you if one does not already exist.

That means most users now begin with a real file they can read and edit immediately.

Important:
- if you already have a `SOUL.md`, kova does not overwrite it
- if the file exists but is empty, kova adds nothing from it to the prompt
...
That alone can noticeably change how kova feels.
...
kova already tries to be helpful and clear. `SOUL.md` should add real personality and style, not restate obvious defaults.
...
# Style
How kova should sound.

# Avoid
What kova should not do.

# Defaults
How kova should behave when ambiguity appears.
```
...
### kova is ignoring parts of my SOUL.md
