...
slug: /
sidebar_position: 0
title: "Kova Agent Documentation"
...
After installing, run `kova setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend kova safely  |
| 🧭 **[Use MCP with kova](/guides/use-mcp-with-kova)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with kova](/guides/use-voice-mode-with-kova)** | Hands-on setup and usage patterns for kova voice workflows            |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define kova's default voice with a global SOUL.md                   |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of kova                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Hermes, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint. kova is a community fork focused on local-first operation and customization.
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Hermes, Nomos, and Psyche models. kova is a community fork with focus on customization.
