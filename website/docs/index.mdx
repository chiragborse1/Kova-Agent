...
| 🗣️ **[Use Voice Mode with kova](/guides/use-voice-mode-with-kova)** | Hands-on setup and usage patterns for Hermes voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define kova' default voice with a global SOUL.md                    |
