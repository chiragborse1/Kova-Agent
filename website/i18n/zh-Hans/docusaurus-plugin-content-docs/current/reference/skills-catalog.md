...
sidebar_position: 5
title: "内置技能目录"
description: "随 Kova Agent 附带的内置技能目录"
---
...
| [`kova-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kova-agent) | 配置、扩展或贡献 Kova Agent。 | `autonomous-ai-agents/kova-agent` |
...
| [`teams-meeting-pipeline`](/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | 通过 Kova CLI 操作 Teams 会议摘要流水线——汇总会议、检查流水线状态、重放任务、管理 Microsoft Graph 订阅。 | `productivity/teams-meeting-pipeline` |
...
| 技能 | 描述 | 路径 |
|-------|-------------|------|
| [`kova-agent-skill-authoring`](/user-guide/skills/bundled/software-development/software-development-kova-agent-skill-authoring) | 编写仓库内 SKILL.md：frontmatter、验证器、结构规范。 | `software-development/kova-agent-skill-authoring` |
...
| [`plan`](/user-guide/skills/bundled/software-development/software-development-plan) | 计划模式：将 Markdown 计划写入 `.kova/plans/`，不执行。 | `software-development/plan` |
