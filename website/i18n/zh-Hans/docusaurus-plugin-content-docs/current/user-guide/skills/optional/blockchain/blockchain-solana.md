...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/blockchain/solana` 安装 |
| 路径 | `optional-skills/blockchain/solana` |
| 版本 | `0.2.0` |
| 作者 | Deniz Alagoz (gizdusum)，由 Kova Agent 增强 |
| 许可证 | MIT |
...
辅助脚本路径：~/.kova/skills/blockchain/solana/scripts/solana_client.py
