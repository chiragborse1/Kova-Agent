...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/mlops/nemo-curator` 安装 |
...
- **[过滤指南](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/nemo-curator/references/filtering.md)** - 30+ 质量过滤器与启发式规则
- **[去重指南](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/nemo-curator/references/deduplication.md)** - 精确、模糊、语义去重方法
