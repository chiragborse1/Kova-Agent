...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/blockchain/evm` 安装 |
| 路径 | `optional-skills/blockchain/evm` |
| 版本 | `1.0.0` |
| 作者 | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Kova Agent |
| 许可证 | MIT |
...
辅助脚本路径：`~/.kova/skills/blockchain/evm/scripts/evm_client.py`
