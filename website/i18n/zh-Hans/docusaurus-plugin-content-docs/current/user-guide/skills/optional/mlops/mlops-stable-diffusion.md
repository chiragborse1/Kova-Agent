...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/mlops/stable-diffusion` 安装 |
...
- **[高级用法](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/stable-diffusion/references/advanced-usage.md)** - 自定义 pipeline、微调、部署
- **[故障排查](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/stable-diffusion/references/troubleshooting.md)** - 常见问题与解决方案
