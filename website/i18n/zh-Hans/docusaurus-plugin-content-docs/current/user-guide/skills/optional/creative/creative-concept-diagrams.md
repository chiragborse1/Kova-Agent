...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/creative/concept-diagrams` 安装 |
| 路径 | `optional-skills/creative/concept-diagrams` |
| 版本 | `0.1.0` |
| 作者 | v1k22（原始 PR），移植至 kova-agent |
| 许可证 | MIT |
...
:::info
以下是 kova 在触发本 skill 时加载的完整 skill 定义。这是 agent 在 skill 激活时所看到的指令内容。
:::
