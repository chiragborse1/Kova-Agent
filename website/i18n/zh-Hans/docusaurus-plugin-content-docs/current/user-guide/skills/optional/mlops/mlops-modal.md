...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/mlops/modal` 安装 |
...
- **[高级用法](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - 多 GPU、分布式训练、成本优化
- **[故障排查](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - 常见问题与解决方案
