...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/mlops/peft` 安装 |
...
- **[高级用法](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** — DoRA、LoftQ、秩稳定化、自定义模块
- **[故障排查](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** — 常见错误、调试、优化
