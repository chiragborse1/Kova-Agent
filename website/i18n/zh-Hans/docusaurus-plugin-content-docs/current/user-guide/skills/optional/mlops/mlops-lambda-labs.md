...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/mlops/lambda-labs` 安装 |
...
- **[高级用法](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/lambda-labs/references/advanced-usage.md)** — 多节点训练、API 自动化
- **[故障排查](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/lambda-labs/references/troubleshooting.md)** — 常见问题及解决方案
