...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/security/oss-forensics` 安装 |
...
> **路径约定**：在本 skill 中，`SKILL_DIR` 指本 skill 安装目录的根目录（包含此 `SKILL.md` 的文件夹）。加载 skill 时，请将 `SKILL_DIR` 解析为实际路径——例如 `~/.kova/skills/security/oss-forensics/` 或对应的 `optional-skills/` 路径。所有脚本和模板引用均相对于该目录。
...
**参考**：IOC 分类法见 [evidence-types.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/evidence-types.md)。
...
**参考**：访问强制推送提交的方法见 [recovery-techniques.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/recovery-techniques.md)。
...
**参考**：GH 事件类型见 [evidence-types.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/evidence-types.md)。
...
**参考**：CDX API 参数见 [github-archive-guide.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/github-archive-guide.md)。
...
**参考**：所有 12 种事件类型及查询模式见 [github-archive-guide.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/github-archive-guide.md)。
...
- 使用 3 种方法恢复强制推送的提交（见 [recovery-techniques.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/recovery-techniques.md)）
...
**常见假设模板**（见 [investigation-templates.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/investigation-templates.md)）：
...
使用 [forensic-report.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/templates/forensic-report.md) 中的模板填写 `investigation-report.md`。
...
- [github-archive-guide.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/github-archive-guide.md) — BigQuery 查询、CDX API、12 种事件类型
- [evidence-types.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/evidence-types.md) — IOC 分类法、证据来源类型、观察类型
- [recovery-techniques.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/recovery-techniques.md) — 恢复已删除的提交、PR、issues
- [investigation-templates.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/references/investigation-templates.md) — 按攻击类型预置的假设模板
- [evidence-store.py](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/scripts/evidence-store.py) — 用于管理证据 JSON 库的 CLI 工具
- [forensic-report.md](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/security/oss-forensics/templates/forensic-report.md) — 结构化报告模板