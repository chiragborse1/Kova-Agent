...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/health/neuroskill-bci` 安装 |
...
将 kova 连接到运行中的 [NeuroSkill](https://neuroskill.com/) 实例，从 BCI 可穿戴设备读取实时脑部与身体指标。用于提供具有认知感知能力的响应、建议干预措施，并随时间追踪心理表现。
