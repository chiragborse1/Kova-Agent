...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/mlops/huggingface-tokenizers` 安装 |
...
- **[训练指南](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/huggingface-tokenizers/references/training.md)** — 训练自定义 tokenizer、配置训练器、处理大型数据集
- **[算法深度解析](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/huggingface-tokenizers/references/algorithms.md)** — BPE、WordPiece、Unigram 详细说明
- **[流水线组件](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/huggingface-tokenizers/references/pipeline.md)** — 归一化器、预分词器、后处理器、解码器
- **[Transformers 集成](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/huggingface-tokenizers/references/integration.md)** — AutoTokenizer、PreTrainedTokenizerFast、特殊 token
