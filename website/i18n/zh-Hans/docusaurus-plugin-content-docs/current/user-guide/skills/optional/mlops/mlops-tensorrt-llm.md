...
| | |
|---|---|
| 来源 | 可选 — 通过 `kova skills install official/mlops/tensorrt-llm` 安装 |
...
- **[优化指南](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/tensorrt-llm/references/optimization.md)** — 量化、批处理、KV cache 调优
- **[多 GPU 配置](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/tensorrt-llm/references/multi-gpu.md)** — 张量/流水线并行、多节点
- **[服务指南](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/tensorrt-llm/references/serving.md)** — 生产部署、监控、自动扩缩容
