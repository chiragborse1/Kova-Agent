...
| | |
|---|---|
| 来源 | 可选 — 使用 `kova skills install official/mlops/qdrant` 安装 |
...
- **[高级用法](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** — 分布式模式、混合搜索、推荐系统
- **[故障排查](https://github.com/NousResearch/Kova-agent/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** — 常见问题、调试、性能调优
