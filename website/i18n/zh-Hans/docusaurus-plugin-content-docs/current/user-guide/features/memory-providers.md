...
完整配置参考参见[插件 README](https://github.com/NousResearch/Kova-agent/blob/main/plugins/memory/hindsight/README.md)。
...
| **依赖** | `pip install supermemory` + [API key](http://app.supermemory.ai/integrations?connect=kova) |
