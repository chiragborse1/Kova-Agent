  ...
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kova-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-kova-agent-skill-authoring',
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/optional/devops/devops-kova-s6-container-supervision',
    ...
    },
    {
      ...
      items: [
        ...
        'guides/run-kova-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-kova',
        'guides/use-soul-with-kova',
        'guides/use-voice-mode-with-kova',
        'guides/build-a-kova-plugin',
