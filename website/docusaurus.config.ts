...
const config: Config = {
  ...
  url: 'https://kova-agent.nousresearch.com',
  baseUrl: '/docs/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/chiragborse1/Kova-Agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/NousResearch/kova-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub', href: 'https://github.com/NousResearch/kova-agent' },
