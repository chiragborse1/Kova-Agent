...
Both publish at:
  https://kova-agent.nousresearch.com/docs/llms.txt
  https://kova-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://kova-agent.nousresearch.com/docs"
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://kova-agent.nousresearch.com/docs\n",
        "Short index: https://kova-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
