...
Invoked by ``kova kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Kova Agent board.
...
def _profile_author() -> str:
    """Mirror of ``kova_cli.kanban._profile_author``."""
    return (
