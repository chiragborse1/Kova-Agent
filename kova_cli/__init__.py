...
- kova chat          - Interactive chat (same as ./kova)
- kova gateway       - Run gateway in foreground
- kova gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `kova setup` on a fresh Pi.
    ...
    kova_cli/stdio.py::configure_windows_stdio() runs later from the entry
