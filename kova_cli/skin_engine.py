"""kova CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.kova/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Kova Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    from kova_cli.skin_engine import get_active_skin, list_skins, set_active_skin
