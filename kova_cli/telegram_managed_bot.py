...
DEFAULT_API_URL = "https://setup.kova-agent.nousresearch.com"
...
DEFAULT_MANAGER_BOT = "KovaSetupBot"
...
def generate_username_slug(length: int = 16) -> str:
    ...
    keeping ``KOVA_<slug>_bot`` under Telegram's 32-character username limit.
    """
...
def generate_bot_username(profile_name: Optional[str] = None) -> str:
    """Generate a secure suggested bot username like ``KOVA_<slug>_bot``.
    ...
    """
    _ = profile_name
    return f"KOVA_{generate_username_slug()}_bot"
