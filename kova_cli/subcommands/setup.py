...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Kova Agent with an interactive wizard. "
        "Run a specific section: kova setup model|tts|terminal|gateway|tools|agent",
    )
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'kova setup' now does this.",
    )
    setup_parser.add_argument(
        "--quick",
        action="store_true",
