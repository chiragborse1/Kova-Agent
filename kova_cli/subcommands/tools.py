...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'kova tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # kova tools disable <name...> [--platform cli]
    ...
    # kova tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `kova tools` runs after you pick a provider that\n"
