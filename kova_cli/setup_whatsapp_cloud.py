...
``cmd_whatsapp_cloud`` in ``kova_cli/main.py``).
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures kova to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  kova needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("  Docs: https://kova-agent.nousresearch.com/docs/user-guide/")
