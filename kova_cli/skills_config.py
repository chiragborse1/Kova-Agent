"""
Skills configuration for Kova Agent.
`kova skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.kova/config.yaml under:
...
from kova_cli.config import cfg_get, load_config, save_config
from kova_cli.colors import Colors, color
from kova_cli.platforms import PLATFORMS as _PLATFORMS
