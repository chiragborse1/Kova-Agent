...
A runner that uses kova-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the kova-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses kova-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in kova format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches kova-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using kova-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with kova Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses kova-Agent's built-in execution environments
    and outputs trajectories in kova-Agent format.
    """
    ...
    def _convert_to_KOVA_format(
        ...
        """
        Convert internal message format to kova trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to kova trajectory format
        trajectory = self._convert_to_KOVA_format(messages, task, completed)
