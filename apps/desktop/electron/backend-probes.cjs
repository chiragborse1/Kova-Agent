 ...
 * resolveKovaBackend (main.cjs). The resolver walks a ladder of
...
/**
 * Return true iff `python -c "import kova_cli"` exits 0.
 *
 ...
 * @returns {boolean}
 */
function canImportKovaCli(pythonPath) {
  if (!pythonPath) return false
  try {
    execFileSync(pythonPath, ['-c', 'import kova_cli'], {
      stdio: 'ignore',
 ...
 * @returns {boolean}
 */
function verifyKovaCli(kovaCommand, opts = {}) {
