 ...
 *
 * The desktop main process can pass KOVA_DASHBOARD_SESSION_TOKEN when it
...
async function fetchPublicText(url, options = {}) {
  ...
  if (protocol !== 'http:' && protocol !== 'https:') {
    throw new Error(`Unsupported Kova backend URL protocol: ${protocol}`)
  }
 ...
 */
async function adoptServedDashboardToken(baseUrl, spawnToken, { childAlive, label = 'Kova backend', ...options }) {
