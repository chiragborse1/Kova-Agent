 ...
 *
 * A public install can end up with `origin=git@github.com:chiragborse1/Kova-Agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/chiragborse1/Kova-Agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/chiragborse1/Kova-Agent'
