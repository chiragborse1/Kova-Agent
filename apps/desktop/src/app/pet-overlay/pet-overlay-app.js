...
export function PetOverlayApp() {
    ...
    return (_jsxs("div", { onPointerDown: e => {
            ...
            width: '100vw'
                    ...
                    position: 'relative',
                    touchAction: 'none'
                }, children: [_jsx("div", { style: { marginBottom: 4 }, children: _jsx(PetBubble, {}) }), _jsxs("div", { style: { lineHeight: 0, position: 'relative' }, children: [_jsx(PetSprite, { info: info }), unread && (_jsx("button", { "aria-label": "Open in Kova", onClick: openApp, onPointerDown: e => e.stopPropagation(), onPointerUp: e => e.stopPropagation(), style: {
                                    alignItems: 'center',
                                    background: 'var(--ui-bg-elevated)',
                                    border: '1px solid var(--ui-stroke-secondary)',
                                    borderRadius: 999,
                                    ...
                                    top: 0,
                                    width: 24
                                }, title: "Open in Kova", type: "button", children: _jsx(Mail, { style: { height: 13, width: 13 } }) }))] })] })] }));
}
