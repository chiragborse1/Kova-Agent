...
import { kovaDirectiveFormatter, type SlashChipKind } from '@/components/assistant-ui/directive-text'
...
export function ChatBar({
  ...
  // Distinguish a cold start ("Starting kova...") from a dropped connection
  ...
  const replaceTriggerWithChip = (item: Unstable_TriggerItem) => {
    ...
    const serialized = kovaDirectiveFormatter.serialize(item)
