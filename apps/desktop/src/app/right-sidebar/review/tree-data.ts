import type { KovaReviewFile } from '@/global'
...
export function buildReviewFlatList(files: KovaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: KovaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
