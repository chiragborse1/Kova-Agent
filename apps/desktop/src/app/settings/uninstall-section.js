...
const OPTIONS = [
    {
        ...
        description: 'Remove this desktop app. The Kova agent, your config, and chats all stay.',
    ...
    },
    {
        ...
        consequence: 'EVERYTHING — the Chat GUI, the Kova agent, and all of your config, chats, secrets, and logs',
