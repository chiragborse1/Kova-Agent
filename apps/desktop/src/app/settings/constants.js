...
export const FIELD_DESCRIPTIONS = defineFieldCopy({
    ...
    timezone: 'Used when Kova needs local time context. Blank uses the system timezone.',
    agent: {
    ...
    updates: {
        nonInteractiveLocalChanges: 'When Kova updates itself from the app (no terminal prompt), keep local source edits (stash) or throw them away (discard). Terminal updates always ask.'
    }
});
