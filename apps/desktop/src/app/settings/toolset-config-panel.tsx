...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/kova'
 ...
 * log inline — the GUI equivalent of the install step `kova tools` runs
