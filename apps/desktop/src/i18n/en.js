...
export const en = {
    ...
    boot: {
        ...
        steps: {
            ...
            startingHermesDesktop: 'Starting Kova Desktop…'
        },
        errors: {
    ...
    notifications: {
        ...
        backendOutOfDateMessage: 'Your Kova backend is older than this desktop build and may not work correctly. Update to align them.',
        ...
        errors: {
            ...
            methodNotAllowed: 'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Kova Desktop.',
    ...
    settings: {
        ...
        appearance: {
            ...
            pet: {
                title: 'Pet',
                intro: 'Adopt an animated petdex mascot that floats over the app and reacts to what Kova is doing — running while tools execute, celebrating on success, sulking on errors.',
                restartHint: 'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Kova, then come back here.',
                on: 'On',
                off: 'Off',
                scaleTitle: 'Size',
        ...
        about: {
            ...
            automaticUpdatesDesc: 'Kova checks for updates automatically in the background and lets you know when one is ready.',
        ...
        gateway: {
            ...
            intro: 'Kova Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Kova backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
            ...
            connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Kova ${version}` : ''}`,
        ...
        providers: {
            ...
            intro: 'Sign in with a subscription — no API key to copy. Kova runs the browser sign-in for you, right here in the app.',
            connected: 'Connected',
            collapse: 'Collapse',
    ...
    commandCenter: {
        ...
        pets: {
            ...
            staleBackend: 'Restart Kova to use pets — the backend predates this feature.',
        ...
        generatePet: {
            ...
            backgroundHint: 'You can close this — Kova will notify you when it’s done.',
    ...
    cron: {
        ...
        newCron: 'New cron',
        emptyDescNew: 'Schedule a prompt to run on a cron expression. Kova will run it and deliver results to the destination you pick.',
    ...
    sidebar: {
        ...
        projects: {
            ...
            staleBackend: 'Update the Kova backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
    ...
    composer: {
        ...
        placeholderReconnecting: 'Reconnecting to Kova…',
    ...
    updates: {
        stages: {
            ...
            pull: 'Almost there…',
            pydeps: 'Finishing up…',
            update: 'Updating Kova…',
            rebuild: 'Rebuilding the desktop app…',
            restart: 'Restarting Kova…',
        ...
        unsupportedMessage: 'This version of Kova can’t update itself from inside the app.',
        ...
        guiSkewBody: 'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Kova desktop app (your AppImage / .deb / .rpm) to match.',
        copy: 'Copy',
        copied: 'Copied',
        done: 'Done',
        applyingBody: 'The Kova updater takes over in its own window and reopens Kova automatically when it’s done. Please don’t reopen Kova yourself while it’s updating.',
        applyingBodyBackend: 'The remote backend is applying the update and will restart. Kova reconnects automatically when it’s back.',
    ...
    install: {
        ...
        failedDesc: 'One of the install steps failed. On Windows, this can happen if another Kova CLI or desktop instance is running. Stop any running Kova instances, then retry. Check the details below or the desktop log for the full transcript.',
        activeDesc: 'This is a one-time setup. The Kova installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
    ...
    onboarding: {
        ...
        recommended: 'Recommended',
        connected: 'Connected',
        featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Kova',
        ...
        flowSubtitles: {
            ...
            device_code: 'Opens a verification page in your browser — Kova connects automatically',
        ...
        autoBrowser: provider => `We opened ${provider} in your browser. Authorize Kova there and you'll be connected automatically — nothing to copy or paste.`,
    ...
    preview: {
        ...
        web: {
            ...
            stillWorking: 'Kova is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
