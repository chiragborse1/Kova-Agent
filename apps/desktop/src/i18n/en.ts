...
export const en: Translations = {
  ...
  fileMenu: {
    ...
    deleteBody: 'It will be moved to the Trash â€” you can restore it from there.',
    pathCopied: 'Path copied'
  },

  boot: {
    ready: 'Kova Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Kova settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Kova Desktopâ€¦'
    },
    errors: {
      backgroundExited: 'Kova background process exited.',
      backgroundExitedDuringStartup: 'Kova background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Kova backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Kova Desktop.',
    ...
    native: {
      ...
      inputBody: 'Kova is waiting for your response.',
      turnDoneTitle: 'Kova finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Kova defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Kova is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Kova asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Kova was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Kova follow your system setting.',
      ...
      embedsDesc:
        'Rich previews load from third-party sites (YouTube, X, â€¦). Ask shows a placeholder until you allow each one; Always loads them automatically; Off keeps plain links.',
      embedsAsk: 'Ask',
      embedsAlways: 'Always',
      embedsOff: 'Off',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Kova is doing â€” running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart â€” the running app started before this feature was added. Quit and reopen Kova, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
        ...
        searchPlaceholder: 'Search petsâ€¦',
        ...
        countCapped: (cap, total) => `Showing ${cap} of ${total} â€” type to narrow it down.`,
        count: n => `${n} pet${n === 1 ? '' : 's'}.`,
        uninstall: name => `Uninstall ${name}`,
        delete: name => `Delete ${name}`,
        deleteTitle: name => `Delete ${name}?`,
        deleteBody: "This permanently deletes the pet â€” it can't be reinstalled.",
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Kova checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Kova configuration...',
    ...
    gateway: {
      ...
      intro:
        'Kova Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Kova backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      remoteDesc:
        'Connect this desktop shell to a remote Kova backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Kova Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` Â· Kova ${version}` : ''}`,
    ...
    mcp: {
      ...
      testing: 'Testing...',
      testOk: count => `Connected â€” ${count} tool${count === 1 ? '' : 's'} available`,
      testFailed: 'Connection failed',
      enableServer: name => `Enable ${name}`,
      disableServer: name => `Disable ${name}`,
      serverEnabled: name => `${name} enabled â€” applies to new sessions.`,
      serverDisabled: name => `${name} disabled â€” applies to new sessions.`,
      ...
      waitingForBrowser: 'Waiting for browserâ€¦',
      authenticate: 'Authenticate',
      unsavedConnect: 'Unsaved â€” save mcp.json to connect.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription â€” no API key to copy. Kova runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    sortAlpha: 'Aâ€“Z',
    sortMostUsedDesc: 'â†“ Most used',
    sortLeastUsedAsc: 'â†‘ Least used',
    ...
    emptyNothingMatches: query => `Nothing matches â€œ${query}â€.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As Kova builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
    ...
    sharePlaceholder: 'Paste a map codeâ€¦',
    copy: 'Copy map code',
    copied: 'Copied!',
  ...
  commandCenter: {
    ...
    changeColorMode: 'Change color modeâ€¦',
    pets: {
      title: 'Pets',
      placeholder: 'Search petsâ€¦',
      loading: 'Loading petdex galleryâ€¦',
      error: 'Could not reach the petdex gallery.',
      staleBackend: 'Restart Kova to use pets â€” the backend predates this feature.',
      ...
      noneAvailable: 'No pets available â€” pick one below to install.'
    },
    generatePet: {
      title: 'Generate a pet',
      placeholder: 'Describe a pet to generateâ€¦',
      ...
      hatch: 'Hatch',
      spawning: 'Spawningâ€¦',
      hatching: 'Hatching your petâ€¦',
      hatchingSub: 'Bringing it to lifeâ€¦',
      hatched: 'It hatched!',
      hatchRow: (_state, done, total) => `Sketching frame ${done} of ${total}â€¦`,
      hatchComposing: 'Piecing it togetherâ€¦',
      hatchSaving: 'Almost thereâ€¦',
      namePlaceholder: 'Name your pet',
      staleBackend: 'Update Kova to generate pets.',
      backgroundHint: 'You can close this â€” Kova will notify you when itâ€™s done.',
      ...
      genericError: 'Generation failed â€” try again or pick a suggestion.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Kova desktop' },
    ...
    hermesActiveSessions: (version, count) => `Kova ${version} Â· Active sessions ${count}`,
    ...
    maintenance: {
      ...
      actionStarted: name => `${name} started â€” tailing log...`,
  ...
  profiles: {
    ...
    manageProfiles: 'Manage profilesâ€¦',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Kova environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Kova will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Kova backend to create projects â€” your backend is older than this desktop app (Settings â†’ Updates â†’ Backend).',
      deleteConfirm: 'This removes the saved project from Kova. Files, git repos, and worktrees stay untouched.',
      ...
      branchesLoading: 'Loading branchesâ€¦',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Kova...',
    placeholderReconnecting: 'Reconnecting to Kovaâ€¦',
    ...
    attachUrlDesc: 'Kova will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      update: 'Updating Kovaâ€¦',
      rebuild: 'Rebuilding the desktop appâ€¦',
      restart: 'Restarting Kovaâ€¦',
    ...
    unsupportedMessage: 'This version of Kova canâ€™t update itself from inside the app.',
    ...
    manualBody: 'You installed Kova from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Kova will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasnâ€™t changed. Update or reinstall the Kova desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Kova updater takes over in its own window and reopens Kova automatically when itâ€™s done. Please donâ€™t reopen Kova yourself while itâ€™s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Kova reconnects automatically when itâ€™s back.',
    applyingClose: 'This window will close while the update runs, then Kova reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Kova needs a one-time install',
    ...
    settingUpTitle: 'Setting up Kova Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Kova CLI or desktop instance is running. Stop any running Kova instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Kova Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Kova is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Kovaâ€¦',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models â€” the recommended way to run Kova',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Kova at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser â€” Kova connects automatically',
    ...
    authorizeThere: 'Authorize Kova there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Kova there and you'll be connected automatically â€” nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Kova inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    linkHint: 'âŒ˜/Ctrl-click for preview pane',
    ...
    largeBody: (label, size) => `${label} is ${size}. Kova will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Kova is restarting...',
      askRestart: 'Ask Kova to restart the server',
      lookingRestart: taskId => `Kova is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Kova is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Kova finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Kova could not restart the server.',
      stillWorking:
        'Kova is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Kova is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Kova gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the â€œ${pattern}â€ pattern to your permanent allowlist (~/.hermes/config.yaml). Kova wonâ€™t ask again for commands like this â€” in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Kova needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Kova needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Kova Desktop to use Save Image.',
    restartToSaveImages: 'Restart Kova Desktop to save images',
