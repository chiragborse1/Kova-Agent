...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Kova is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Kova, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Kova runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Kova backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
  ...
  updates: {
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Kova desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Kova updater takes over in its own window and reopens Kova automatically when it’s done. Please don’t reopen Kova yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Kova reconnects automatically when it’s back.',
  ...
  onboarding: {
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Kova there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}� pattern to your permanent allowlist (~/.hermes/config.yaml). Kova won’t ask again for commands like this — in this session or any future one.`,
