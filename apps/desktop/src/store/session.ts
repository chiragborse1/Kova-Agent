...
import type { SessionInfo, UsageStats } from '@/types/kova'
...
const COMPOSER_MODEL_KEY = 'kova.desktop.composer.model'
const COMPOSER_PROVIDER_KEY = 'kova.desktop.composer.provider'
const COMPOSER_EFFORT_KEY = 'kova.desktop.composer.reasoning-effort'
const COMPOSER_FAST_KEY = 'kova.desktop.composer.fast'
...
const LAST_SESSION_KEY = 'kova.desktop.lastSessionId'
...
function workspaceCwdKey(connection: KovaConnection | null = $connection.get()): string {
...
export const $connection = atom<KovaConnection | null>(null)
...
export const setConnection = (next: Updater<KovaConnection | null>) => updateAtom($connection, next)
