...
const copy = {
  ...
  availableBody: 'A new version of Kova is ready to install.',
  availableTitleBackend: 'Backend update available',
  availableBodyBackend: 'A newer version of the connected Kova backend is ready to install.',
...
describe('resolveUpdateCopy', () => {
  it('client target with commits: client title + client body', () => {
    ...
    expect(r.body).toBe('A new version of Kova is ready to install.')
  })
