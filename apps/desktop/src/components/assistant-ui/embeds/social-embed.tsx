...
const SCRIPT: Record<string, { id: string; src: string }> = {
  instagram: { id: 'kova-ig-embed', src: 'https://www.instagram.com/embed.js' },
  tiktok: { id: 'kova-tt-embed', src: 'https://www.tiktok.com/embed.js' },
  twitter: { id: 'kova-tw-embed', src: 'https://platform.twitter.com/widgets.js' }
}
