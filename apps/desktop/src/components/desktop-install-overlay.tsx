        ...
        <div className="w-full max-w-xl rounded-xl border border-(--stroke-nous) bg-card p-8 shadow-nous">
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <Button
                onClick={() => {
                  window.kovaDesktop?.openExternal?.(ups.docsUrl)
                }}
                size="sm"
                variant="ghost"
              >
            ...
            <div className="flex items-center justify-end">
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    await window.kovaDesktop?.cancelBootstrap?.()
                  } catch {
          ...
          <div className="flex-shrink-0 bg-card p-4">
            <div className="flex items-center justify-between gap-2">
              <span className="text-xs text-muted-foreground">
                ...
                <code className="rounded bg-muted/50 px-1 py-0.5 font-mono">%LOCALAPPDATA%\kova\logs\</code>
              </span>
              <div className="flex gap-2">
                ...
                <Button
                  onClick={async () => {
                    ...
                    try {
                      await window.kovaDesktop?.resetBootstrap?.()
                    } catch {
