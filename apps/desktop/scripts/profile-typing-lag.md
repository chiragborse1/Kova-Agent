...
cd apps/desktop
XCURSOR_SIZE=24 KOVA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/kova-typing
# → /tmp/kova-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/kova-typing.before.heapsnapshot
# → /tmp/kova-typing.after.heapsnapshot
```
