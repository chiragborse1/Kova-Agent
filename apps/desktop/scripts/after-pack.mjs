 ...
 *
 * Stamps the Kova icon + identity onto the packed Windows Kova.exe via
...
export default async function afterPack(context) {
  ...
  try {
    ...
    console.warn(`[after-pack] exe identity stamp failed (${err.message}); Kova.exe keeps the stock Electron icon`)
  }
}
