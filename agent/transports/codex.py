...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around kova's web-provider config and
        ...
        # native search engine for xAI sessions instead of kova's
        # configured web provider (Tavily/etc.), and those results bypass
        # kova's tool-trace / citation plumbing (they arrive baked into the
