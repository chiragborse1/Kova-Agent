...
projection into kova' display, approval bridging, transcript projection into
...
"codex_app_server"`. kova' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("KOVA_KANBAN_TASK"):
            ...
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "KOVA_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("KOVA_HOME", os.path.expanduser("~/.kova")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "kova",
        client_title: str = "Kova Agent",
