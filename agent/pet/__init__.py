...
an 8-column × 9-row atlas; older kova/petdex sheets used an 8-row atlas.
kova infers the row taxonomy from the sheet and maps agent activity onto
...
- :mod:`agent.pet.store`     — install / list / resolve pets on disk
                               (profile-aware via ``get_kova_home()``).
