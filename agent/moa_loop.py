...
MoA-enabled; the normal Kova Agent loop still owns tool calling and turn
...
def _reference_messages(messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    (a) re-bills the ~8K-token kova system prompt per reference per
...
def aggregate_moa_context(
    *,
    ...
    synth_prompt = (
        ...
        "Kova Agent. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Kova Agent loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
