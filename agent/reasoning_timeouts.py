...
first content token) routinely exceed kova's default chat-model
stale detectors:

* Stream stale detector:   ``KOVA_STREAM_STALE_TIMEOUT``     default 180s
                           ``agent/chat_completion_helpers.py:2544``
* Non-stream stale detector: ``KOVA_API_CALL_STALE_TIMEOUT``  default 90s
                           ``run_agent.py:1140``
