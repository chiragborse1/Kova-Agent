...
See the ``kova-agent-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "Pinned skills (marked via 'kova curator pin') CAN be improved — "
...
def _run_review_in_thread(
    ...
    try:
        with open(os.devnull, "w", encoding="utf-8") as _devnull, \
            ...
            # scratch (fresh _KOVA_now() timestamp, fresh
