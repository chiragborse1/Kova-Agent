...
_SCHEMA_OVERRIDES: Dict[str, Dict[str, Any]] = {
    ...
    "updates.refresh_cua_driver": {
        "type": "bool",
        "description": (
            "Refresh an already-installed cua-driver during kova update. "
...
async def check_hermes_update(force: bool = False):
    ...
    ``POST /api/hermes/update`` actually runs ``kova update``.
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "discord": {
        "name": "Discord",
        "description": "Connect to Discord DMs, channels, and threads.",
    ...
    "mattermost": {
        "name": "Mattermost",
        "description": "Connect to Mattermost channels and direct messages.",
    ...
    "email": {
        ...
        "docs_url": "https://github.com/chiragborse1/Kova-Agent",
        "env_vars": (
            "EMAIL_ADDRESS",
            "EMAIL_PASSWORD",
            "EMAIL_IMAP_HOST",
    ...
    "dingtalk": {
        "name": "DingTalk",
        "description": "Connect to DingTalk groups (钉钉).",
    ...
    "google_chat": {
        "name": "Google Chat",
        "description": "Connect to Google Chat via Cloud Pub/Sub.",
        "docs_url": "https://github.com/chiragborse1/Kova-Agent",
    },
    "wecom": {
    ...
    "qqbot": {
        "name": "QQ Bot",
        "description": "Connect to a QQ Bot from the QQ Open Platform.",
...
async def prune_sessions_endpoint(body: SessionPrune):
    """Delete ended sessions matching filters (mirrors `kova sessions prune`)."""
    has_window = (
...
async def auth_mcp_server(name: str, profile: Optional[str] = None):
    ...
    Mirrors ``kova mcp login``: wipe cached OAuth state so the probe forces
...
async def get_toolset_models(
    ...
    The GUI counterpart of the model picker `kova tools` runs after a
