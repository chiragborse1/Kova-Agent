...
the get_anchored_view / get_messages_around primitives in kova_state.
...
# Third-party integrations tag their sessions with KOVA_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from kova_state import DEFAULT_DB_PATH
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches kova conversation history only. It is not evidence "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about kova conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another kova profile's database "
