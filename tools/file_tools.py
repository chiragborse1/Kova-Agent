...
def _check_sensitive_path(filepath: str, task_id: str = "default") -> str | None:
    ...
    if hermes_config and (resolved == hermes_config or normalized == hermes_config):
        return (
            ...
            "Edit ~/.hermes/config.yaml directly or use 'kova config' instead."
        )
    return None
...
def _check_cross_profile_path(filepath: str, task_id: str = "default") -> str | None:
    """Return a soft-guard warning when ``filepath`` lands in another kova profile's scoped area, a host-side sandbox-mirror of authoritative profile
...
PATCH_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "cross_profile": {
                "type": "boolean",
                "description": "Opt out of the cross-profile soft guard. Defaults to false. Set true ONLY after explicit user direction to edit another profile's skills/plugins/cron/memories.",
                "default": False,
            },
        },
        "required": ["mode"],
