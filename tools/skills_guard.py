...
Trust levels:
  - builtin:   Ships with kova. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.kova/\.env|\~/.kova/\.env',
     "KOVA_env_access", "critical", "exfiltration",
     "directly references kova secrets file"),
    ...
    (r'\.kova/config\.yaml|\.kova/SOUL\.md',
     "KOVA_config_mod", "critical", "persistence",
     "references kova configuration files directly"),
...
# scan. `.skillignore` is the kova-native name; `.clawhubignore` is honored
