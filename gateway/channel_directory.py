...
~/.kova/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_kova_home() / "channel_directory.json"
...
CHANNEL_ALIASES_PATH = get_kova_home() / "channel_aliases.json"
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_kova_home() / "sessions" / "sessions.json"
