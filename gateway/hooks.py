...
Hooks are discovered from ~/.kova/hooks/ directories, each containing:
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"KOVA_hook_{hook_name}"
